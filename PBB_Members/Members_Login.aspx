<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Members_Login.aspx.cs" Inherits="PrasarNet.PBB_Members.Members_Login" EnableEventValidation="false" %>
                        ...
                        <div class="panel-body grad2">
                            ...
                            <form name="form" id="form" class="form-horizontal" enctype="multipart/form-data"
                                ...
                                <asp:UpdatePanel runat="server">
                                    <ContentTemplate>
                                        <div align="center" id="rbllogintype" runat="server" visible="false">
                                            <asp:RadioButtonList ID="rblusertype" runat="server" class="radiobuttonlistcls" RepeatDirection="Horizontal"
                                                TabIndex="1" AutoPostBack="True" OnSelectedIndexChanged="rblusertype_SelectedIndexChanged">
                                                <asp:ListItem Selected="True" Value="1">E-Mail&nbsp;</asp:ListItem>
                                                <asp:ListItem Value="2">Mobile&nbsp;</asp:ListItem>
                                            </asp:RadioButtonList>
                                        </div>
                                        <br />
                                        <div id="divemail" runat="server" align="center" visible="false">
                                            <div class="input-group">

                                                <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
                                                <asp:TextBox ID="txtemail" runat="server" class="form-control" ValidationGroup="otp" autocomplete="off" CausesValidation="true" placeholder="E-Mail" AutoPostBack="True" OnTextChanged="txtemail_TextChanged"></asp:TextBox>

                                                <div align="left">
                                                    <asp:Label ID="lblemailmsg" runat="server" Text="" Font-Size="Small" Font-Bold="true" ForeColor="Red"></asp:Label>
                                                </div>
                                                <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender72" runat="server"
                                                    TargetControlID="txtemail" ValidChars="1234567890abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ@#._-!^+|:;<>,$()/\:;&"></ajaxToolkit:FilteredTextBoxExtender>
                                                <%--<input id="user" type="text" class="form-control" name="user" value="" placeholder="User">--%>
                                            </div>
                                            <div align="left" runat="server">
                                                <asp:RegularExpressionValidator Font-Size="small" ValidationGroup="otp" Font-Bold="true" ID="RegularExpressionValidator4" runat="server" ControlToValidate="txtemail"
                                                    Display="Dynamic" ErrorMessage="Not a valid Email!!" ForeColor="Red"
                                                    ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
                                                <asp:RequiredFieldValidator ID="rfvemail" ValidationGroup="otp" runat="server" ErrorMessage=""
                                                    ControlToValidate="txtemail" ForeColor="Red" SetFocusOnError="True" Style="font-size: small; font-weight: 700;"
                                                    Display="Dynamic"></asp:RequiredFieldValidator>
                                            </div>

                                        </div>

                                        <div id="divmob" runat="server" visible="false" align="center">
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="glyphicon glyphicon-phone"></i></span>
                                                <asp:TextBox ID="txtmob" MaxLength="10" runat="server" class="form-control" CausesValidation="true" autocomplete="off" ValidationGroup="otp" placeholder="Mobile Number" AutoPostBack="True" OnTextChanged="txtmob_TextChanged"></asp:TextBox>
                                                <div align="left">
                                                    <asp:Label ID="lblmobmsg" runat="server" Text="" Font-Size="Small" Font-Bold="true" ForeColor="Red"></asp:Label>
                                                </div>
                                                <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server"
                                                    TargetControlID="txtmob" ValidChars="1234567890"></ajaxToolkit:FilteredTextBoxExtender>
                                                <%--<input id="user" type="text" class="form-control" name="user" value="" placeholder="User">--%>
                                            </div>
                                            <div align="left" runat="server">
                                                <asp:RequiredFieldValidator ID="rfvmob" ValidationGroup="otp" runat="server" ErrorMessage=""
                                                    ControlToValidate="txtmob" ForeColor="Red" SetFocusOnError="True" Style="font-size: small; font-weight: 700;"
                                                    Display="Dynamic"></asp:RequiredFieldValidator>
                                            </div>
                                        ...
                                        <div id="div1" runat="server" visible="true" align="center">
                                            <div class="input-group">
                                                ...
                                                <asp:TextBox ID="txtemail_mob" runat="server" class="form-control" autocomplete="off" ValidationGroup="otp" 
                                                    placeholder="Email/Mobile Number"></asp:TextBox>

                                                <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" runat="server" FilterMode="InvalidChars" FilterType="Custom"
                                                    TargetControlID="txtemail_mob" InvalidChars="*=+~()[]{}\| :/!;,%<>?"></ajaxToolkit:FilteredTextBoxExtender>
                                                <%--<input id="user" type="text" class="form-control" name="user" value="" placeholder="User">--%>
                                            </div>
                                            <div align="left">
                                                <asp:Label ID="lblemail_mob_err" runat="server" Text="" Font-Size="Medium" Font-Bold="true" ForeColor="Red"></asp:Label>
                                            </div>
                                            <div align="left" runat="server">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ValidationGroup="otp" runat="server" ErrorMessage="Email/Mobile No Required!!"
                                                    ControlToValidate="txtemail_mob" ForeColor="Red" SetFocusOnError="True" Style="font-size: medium; font-weight: 700;"
                                                    Display="Dynamic"></asp:RequiredFieldValidator>
                                            </div>
                                            <br />
                                        </div>
                                        <div id="divbtnotp" runat="server" class="form-group" align="center" visible="true">

                                            <!-- Button -->
                                            <asp:Button ID="btnsendotp_M_E" runat="server" Text="Send OTP" Visible="true" class="btn" ValidationGroup="otp"
                                                Style="background-color: #99FFCC; color: Black; font-weight: bold"
                                                Width="130px" OnClick="btnsendotp_M_E_Click" />

                                        </div>
                                        <div id="divotp" runat="server" visible="false" align="center">
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                                                <asp:TextBox ID="txtOTP" type="text" runat="server" class="form-control" placeholder="OTP" ValidationGroup="otp"  autocomplete="off"
                                                    ClientIDMode="Static"></asp:TextBox>
                                                <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender6" runat="server"
                                                TargetControlID="txtOTP" ValidChars="1234567890abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ"></ajaxToolkit:FilteredTextBoxExtender>
                                            </div>                                            
                                            <div align="left">
                                                <asp:RequiredFieldValidator ID="rfvpswd" runat="server" ErrorMessage="OTP Required!!"
                                                    ControlToValidate="txtOTP" ForeColor="Red" SetFocusOnError="True" Style="font-size: Medium; font-weight: 700;"
                                                    Display="Dynamic"></asp:RequiredFieldValidator>
                                            </div>
                                            <%--<input id="user" type="text" class="form-control" name="user" value="" placeholder="User">--%>
                                        </div>
                                        <br />
                                        <div id="divbtn" runat="server" class="form-group" align="center" visible="false">
                                            <!-- Button -->
                                            <asp:Button ID="btnlogin" runat="server" Text="LogIn" Visible="false" class="btn" Style="background-color: #99FFCC; color: Black; font-weight: bold"
                                                Width="130px" OnClick="btnlogin_Click" />
                                            <asp:Button ID="btnsendotp" runat="server" Text="Send OTP" class="btn" Style="background-color: #99FFCC; color: Black; font-weight: bold"
                                                Width="130px" OnClick="btnsendotp_Click" Visible="false" />
                                            &nbsp;&nbsp;&nbsp;
                                            <asp:Button ID="btnresend" runat="server" Text="Re-Send OTP" class="btn" Style="background-color: #99FFCC; color: Black; font-weight: bold" ValidationGroup="otp"
                                                Width="130px" OnClick="btnresend_Click" Visible="false" />
                                            <br />
                                            <br />
                                            <asp:Label runat="server" ID="lblresult" ForeColor="Red" Font-Size="Medium" Font-Bold="true"></asp:Label>
                                        </div>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </form>
