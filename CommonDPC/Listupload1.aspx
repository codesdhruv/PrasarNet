<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="Listupload1.aspx.cs" Inherits="PrasarNet.CommonDPC.Listupload1" %>
        ...
        <div id="divprvdpc" runat="server" visible="false" class="panel panel-collapse">
            <asp:Panel ID="Panel1" runat="server" BorderStyle="Solid" BorderColor="cyan" BorderWidth="5" ScrollBars="Both" Width="90%" Height="300px">
                ...
                <asp:GridView ID="grdDPCdetails" runat="server" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True"
                    ...
                    OnRowCommand="grdDPCdetails_RowCommand" CssClass="auto-style4">
            ...
            <div class="row table-bordered fa-upload border fa-align-center" style="padding: 5px; margin: 5px; border: thick solid #00FFFF;">
                <div class="col-10">
                 ...
                 <div class="row table-bordered fa-upload border fa-align-right" style="padding: 5px; margin: 5px; border: thick solid ;">
                    ...
                    <asp:LinkButton ID="lbclose" Font-Size="Large" BackColor="PaleVioletRed" runat="server" OnClick="btnCancel_Click">close</asp:LinkButton>
                </div>
                <%--   <div class="col-10">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card-body">
                            ...
                            <button style="margin-bottom: 10px;" type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">
                                <i class="fa fa-plus-circle"></i>View Excel (Deeemed Dep. Employee)</button>
                ...
                <div runat="server" id="divuploadpbexcel" width="35%" class="card-header bg-light text-uppercase fa-align-right align-content-lg-center align-content-center" style="table-layout: fixed; border-style: solid; border-width: thick; border-color: green">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card-body">
                            ...
                            <button style="margin-bottom: 10px;" type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModalPB">
                                <i class="fa fa-plus-circle"></i>View Excel (PB Employee)
                            </button>
