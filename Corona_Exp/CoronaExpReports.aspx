<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CoronaExpReports.aspx.cs" Inherits="PrasarNet.Corona_Exp.CoronaExpReports" MasterPageFile="~/Site1.Master" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentSection" runat="server">
    <div class="content gradbody" style="margin-bottom: 150px">
        ...
        <div id="divgrd" runat="server" visible="true" class="row" style="margin: auto">
            ...
            <div align="center" class=" col-md-12 col-sm-12 col-lg-12 " runat="server"
                id="div6">
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body grad2 table-responsive">
                        ...
                        <asp:GridView ID="grdexp" runat="server" AutoGenerateColumns="false" BackColor="#F8F9F9"
                            ...
                            ToolTip="Issue Tapes List" PageSize="10" OnPageIndexChanging="grdexp_PageIndexChanging">
                            ...
                            <columns>
                                ...
                                <asp:TemplateField HeaderText="Information Given By">
                                    <itemtemplate>
                                        <div style="padding: 15px" runat="server" align="center">
                                            <asp:Label ID="lblinfogivenby" runat="server" Font-Bold="True" ForeColor="Black" Text='<%#Eval("InformationGivenBy") %>' class="font2" />
                                        </div>
                                    </itemtemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Information Recieved On">
                                    <itemtemplate>
                                        <div style="padding: 15px" runat="server" align="center">
                                            <asp:Label ID="lblinforevdOn" runat="server" Font-Bold="True" ForeColor="Black" Text='<%#Eval("createdon", "{0:dd-MMM-yyyy}") %>' class="font2" />
                                        </div>
                                    </itemtemplate>
                                </asp:TemplateField>
                            </columns>
