<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="PrasarNet.Login" EnableEventValidation="false" %>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body grad2">
                            ...
                            <asp:ListItem Value="4">Management&nbsp;</asp:ListItem>--%>
                                ...
                                <div id="divusr1" runat="server" visible="false" align="center">
                                ...
                                <br />
                                <div id="divpswd1" runat="server" class="input-group" visible="false " align="center">
                            ...
                            Password</span>
                                ...
                                <br />
                                <div class="form-group" align="center" id ="divlogin" runat="server" visible="false">
                                    <!-- Button -->
                                    <asp:Button ID="btnlogin" runat="server" Text="LogIn" class="btn" Style="background-color: #99FFCC; color: Black; font-weight: bold"
