<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Approve.aspx.cs" Inherits="PrasarNet.Approve"
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentSection" runat="server">
    <div class="containerh gradbody">
        ...
        <div id="divgrd" runat="server" visible="true" class="row" width="500px" style="margin: auto;">
            ...
            <div align="center" class=" col-md-2 col-sm-3 col-lg-1" runat="server" id="div6">
            </div>
            <div align="left" class=" col-md-8 col-sm-6 col-xs-12 col-lg-10" runat="server" id="div7">
                <div class="panel panel-primary">
                    <%--<div class="panel-heading">
                            :: Motivational Quotes ::</div>--%>
                    <div class="panel-body grad3">
                        <br />
                        <asp:LinkButton ID="lnkquote" ForeColor="Blue" BackColor="#FEF9E7" runat="server"
                            class="font2" Font-Bold="True" OnClick="lnkquote_Click"
                            Font-Underline="False">
                            1. Select a Motivational Quotes to be shown on DashBoard.</asp:LinkButton>
                        <br />
                        <br />
                        <asp:LinkButton ID="lnkphoto" ForeColor="Blue" BackColor="#E8F8F5" runat="server"
                            Font-Bold="True" class="font2" OnClick="lnkphoto_Click"
                            Font-Underline="False">
                            2. Approve/Select Photos to be shown on DashBoard's Photo-Slider.</asp:LinkButton>
                        <br />
                        <br />
                    </div>
                </div>
            </div>
            <div align="center" class=" col-md-2 col-sm-3 col-lg-1" runat="server" id="div9">
            </div>
        </div>
    </div>
</asp:Content>
