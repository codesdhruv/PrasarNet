<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="G_Rpt_Deptt.aspx.cs" Inherits="PrasarNet.EGrievance.G_Rpt_Deptt" MasterPageFile="~/Site1.Master" EnableEventValidation="false" %>
...
<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="HeadContent">
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            ...
            var options = {
                title: 'Department Wise Grievances',
                ...
                hAxis:
                {
                    title: 'Department', direction: -1, slantedText: true, slantedTextAngle: 65
            ...
            $.ajax({
                type: "POST",
                url: "G_Rpt_Deptt.aspx/GetChartDatarvd",
                data: '{}',
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentSection" runat="server">
    <div class="content gradbody" style="margin-bottom: 150px">
        ...
        <div id="Div6" runat="server" style="padding-top: 20px; padding-bottom: 20px; margin: auto">
            ...
            <div align="center" runat="server" class="col-md-10  col-lg-10 " style="padding-top: 0px; padding-bottom: 25px" visible="true">
                <div runat="server" align="center" style="border: medium ridge #000000; margin: 0 20px 10px 20px;">
                    <div runat="server" align="center" style="padding: 7px">
                        <asp:Label runat="server" ID="Label3" CssClass="font2" ForeColor="Black" Font-Underline="true" Font-Bold="true" Text=":: Department Wise Grievance Received/Resolved ::"></asp:Label>
                        <br />
                        <br />
                    </div>
                        ...
                        <div align="center" class=" col-md-12 col-lg-12" align="center">
                            ...
                            <div class="panel panel-primary">
                                <div class="panel-heading grad3">
                                    <span style="font-weight: bold; color: Black;" class="font2">:: Department Wise Report ::</span>
                                </div>
                                <div class="panel-body grad2 table-responsive">
                                    <div id="divprisearch" style="text-align: center; padding: 10px; margin: auto" runat="server" visible="false" class="row">
                                        ...
                                        <div class="col-lg-4 " style="padding: 7px">
                                            <asp:LinkButton ID="btnprint1" runat="server" CssClass="btn" CausesValidation="False"
                                                Width="160px" BackColor="#F5B7B1" BorderColor="Black" BorderStyle="Ridge" BorderWidth="1px">
                                        ...
                                        <div class="col-lg-4 " style="padding: 7px">
                                            <asp:LinkButton ID="btnexporttoexcel" runat="server" CssClass="btn" CausesValidation="False"
                                                Width="160px" BackColor="LightGreen" BorderColor="Black" BorderStyle="Ridge" BorderWidth="1px">
                                    ...
                                    <asp:Panel ID="panelprint" runat="server">
                                        ...
                                        <asp:GridView ID="grddeptwise" runat="server" AutoGenerateColumns="False" EmptyDataText="..No Records Found.." HorizontalAlign="Center" BackColor="#F8F9F9"
                                            PageSize="20" ShowHeaderWhenEmpty="True" ToolTip="Department Wise Reports"
                                            ...
                                            <columns>
                                                ...
                                                <asp:TemplateField HeaderText="Department" Visible="true">
                                                    <itemtemplate>
                                                        <div style="padding: 15px" runat="server" align="center">
                                                            <asp:Label ID="lbldept" Font-Bold="true" ForeColor="Black" runat="server" Text='<%#Eval("department") %>' class="font2" />
                                                        </div>
                                                    </itemtemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Initial Action Taken By PBGS inc Forwarded & Resolved" Visible="true">
                                                    <itemtemplate>
                                                        <div style="padding: 15px" runat="server" align="center">
                                                            <asp:Label ID="lblinitial" Font-Bold="true" ForeColor="Black" runat="server" Text='<%#Eval("fwd_PBGS") %>' class="font2" />
                                                        </div>
                                                    </itemtemplate>
                                                ...
                                                <asp:TemplateField HeaderText="No of Grievance Resolved" Visible="true">
                                                    <itemtemplate>
                                                        <div style="padding: 15px" runat="server" align="center">
                                                            <asp:Label ID="lblinitial" Font-Bold="true" ForeColor="Black" runat="server" Text='<%#Eval("Res") %>' class="font2" />
                                                        </div>
                                                    </itemtemplate>
                                                    <itemstyle width=""></itemstyle>
                                                </asp:TemplateField>
