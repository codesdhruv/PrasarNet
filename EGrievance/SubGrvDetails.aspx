<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="SubGrvDetails.aspx.cs" Inherits="PrasarNet.EGrievance.SubGrvDetails" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentSection" runat="server">
    <div class="content gradbody" style="margin-bottom: 150px">
        ...
        <div id="div3" style="text-align: left; padding-left: 25px; padding-bottom: 10px" runat="server" visible="false">
        ...
        <div id="div14" style="text-align: center; padding-left: 25px; padding-bottom: 10px" runat="server" visible="true" align="center">
                <asp:Label runat="server" ID="lblsubject" CssClass="font4" ForeColor="Green" Font-Underline="true" Font-Bold="true" style="font-size: xx-large"></asp:Label>
        </div>
