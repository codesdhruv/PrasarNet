<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeFile="G_SubGrievances.aspx.cs" Inherits="EGrievance_G_SubGrievances" EnableEventValidation="false" %>

<%--<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="G_SubGrievances.aspx.cs" Inherits="PrasarNet.EGrievance_G_SubGrievances" MasterPageFile="~/Site1.Master" EnableEventValidation="false" %>--%>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentSection" runat="server">
    <div class="content gradbody" style="margin-bottom: 150px">
        ...
        <div runat="server" align="center" style="border: medium ridge #000000; margin: 0 20px 10px 20px;">
            <div runat="server" align="center" style="padding: 7px">
                <asp:Label runat="server" ID="Label4" CssClass="font2" ForeColor="Black" Font-Underline="true" Font-Bold="true" Text=":: Pending ::"></asp:Label>
            </div>
            <div class="row" runat="server" width="95%" align="center" style="margin: auto; padding-top: 7px; padding-bottom: 7px; padding-right: 0px; padding-left: 0px; align-items: center">
