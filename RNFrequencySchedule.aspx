<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RNFrequencySchedule.aspx.cs"
    Inherits="PrasarNet.RNFrequencySchedule" MasterPageFile="~/Site1.Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MenuContent" runat="server">
    <div id="Div7" class="row gradhead" runat="server" style="margin: auto">
            ...
            <div align="center" class=" col-md-10 col-sm-10 col-lg-10" runat="server" id="div6">
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading grad3">
                        <span style="font-size: medium; font-weight: bold; color: Black;">:: Frequency Schedule
                            ::</span>
                    </div>
