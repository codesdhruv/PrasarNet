<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MonthlyRetirements.aspx.cs"
    Inherits="PrasarNet.MonthlyRetirements" MasterPageFile="~/Site1.Master" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentSection" runat="server">
    <div class="content gradbody">
        ...
        <div class="row" style="padding: 0px 0px 10px 0px; margin: auto">
            <div class=" col-md-12 col-sm-12 col-xs-12 col-lg-12" runat="server" id="div3" align="right"
                style="padding-right: 30px;">
                <asp:Button ID="btnback" runat="server" Text="< Back" CssClass="btn grad4" Style="color: Black; font-weight: bold"
                    Width="90px" OnClick="btnback_Click" />
            </div>
        </div>
        <div class="row" style="margin: auto">
            <div align="center" class=" col-md-2 col-sm-2  col-lg-2" runat="server" id="div5">
            </div>
            <div align="center" class=" col-md-8 col-sm-8  col-lg-8" runat="server" id="div6">
                <div class="panel panel-primary">
                    <div class="panel-heading grad3">
                        <span style="color: Black; font-weight: bold;" class="fontingrid">List of Officials
                            Retiring This Month(As updated in HRIS)</span>
                        <br />
                        <span style="color: Black; font-weight: bold;" class="font2">(Wishing the Following
                            Officials a Very Happy and Healthy Retired Life)</span>
                    </div>
                    <div class="panel-body grad2 table-responsive">
                        <%-- <div id="Div4" runat="server" class="glyphicon" style="background-color: #F4A460"
                            align="right">
                            <i class="glyphicon glyphicon-print form-control-feedback"></i>
                            <asp:Button ID="btnprint" runat="server" Text="Print" CssClass="btn gradbody" Style="color: Black;
                                font-weight: bold" Width="90px" OnClick="btnprint_Click" />
                        </div>--%>
                    ...
                    <span style="font-weight: bold; color: #000000">Print</span></asp:LinkButton>
                        <br />
                        <br />
                        <asp:GridView ID="grdretirements" runat="server" AutoGenerateColumns="false" AllowPaging="true"
                            PageSize="40" HeaderStyle-BackColor="#61A6F8" HeaderStyle-Font-Bold="true" HeaderStyle-ForeColor="White"
                            HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" EmptyDataText=".. Records Not Found .."
                            ShowHeaderWhenEmpty="True" Width="85%" OnPageIndexChanging="grdretirements_PageIndexChanging"
                            ForeColor="#333333" BorderStyle="Solid" BorderWidth="2px">
                            <alternatingrowstyle backcolor="White" />
                            <columns>
                                <asp:TemplateField HeaderText="S.No.">
                                    <itemtemplate>
                                        <asp:Label ID="lblSNo" ForeColor="Black" runat="server" Text='<%#Container.DataItemIndex+1 %>' />
                                    </itemtemplate>
                                ...
                                <asp:TemplateField HeaderText="Employee Details">
                                    <itemtemplate>
                                        <div style="padding: 8px">
                                            <asp:Label ID="Label5" class="font" ForeColor="Black" Font-Bold="true" runat="server"
                                                Text='<%# Eval("fullname") %>'></asp:Label>
                                            <br />
                                            <asp:Label ID="Label1" ForeColor="Black" class="fontingrid" runat="server" Text="("></asp:Label>
                                            <asp:Label ID="Label7" ForeColor="Black" class="fontingrid" runat="server" Text='<%# Eval("DesignationName") %>'></asp:Label>
                                            <asp:Label ID="Label2" ForeColor="Black" class="fontingrid" runat="server" Text=")"></asp:Label>
                                            <br />
                                            <%-- <asp:Label ID="Label8" Font-Size="Small" runat="server" Text='<%# Eval("DateOfBirthChrist") %>'  DataFormatString="{0:dd-MMM-yyyy}"></asp:Label>--%>
                                        </div>
                                    </itemtemplate>
                                ...
                                <%--  <asp:TemplateField HeaderText="Designation">
                                        <ItemTemplate>
                                            <asp:Label ID="Label7" runat="server" Text='<%# Eval("DesignationName") %>'></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle Width="150px" />
                                    </asp:TemplateField>--%>
                                <%--<asp:TemplateField HeaderText="Date of Birth">
                                        <ItemTemplate>
                                            <asp:Label ID="Label8" runat="server" Text='<%# Eval("DateOfBirthChrist") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>--%>
                                <asp:TemplateField HeaderText="Station">
                                    <itemtemplate>
                                        <div style="padding-left: 10px">
                                            <asp:Label ID="Label9" ForeColor="Black" class="font" runat="server" Text='<%# Eval("stationdetails") %>'></asp:Label>
                                        </div>
                                    </itemtemplate>
                                    <itemstyle horizontalalign="Left" />
                                    <headerstyle horizontalalign="Center" />
                                ...
                                <%-- <asp:TemplateField HeaderText="Office Type">
                                        <ItemTemplate>
                                            <asp:Label ID="Label10" runat="server" Text='<%# Eval("stnType") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>--%>
                                <%-- <asp:TemplateField HeaderText="Office">
                                        <ItemTemplate>
                                            <asp:Label ID="Label11" runat="server" Text='<%# Eval("StationName") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>--%>
                                <%-- <asp:TemplateField HeaderText="Verified ?">
                                        <ItemTemplate>
                                            <asp:Label ID="lblVerified" runat="server" Text='<%# iif(Eval("IsVerified")="0","No", "Yes") %>'></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:TemplateField>--%>
                            </columns>
