<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="App_ActionTaken.aspx.cs" Inherits="PrasarNet.PBHS.App_ActionTaken" MasterPageFile="~/Site1.Master" EnableEventValidation="false" %>
            ...
            <div id="divgrd" visible="true" align="center" class=" col-md-12 col-sm-12 col-lg-12"
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading grad3">
                        <span style="font-weight: bold; color: Black;" class="font2">:: Application(s) and their Status ::</span>
                    </div>
                                                ...
                                                <asp:TemplateField HeaderText="Forward/Closed with Remarks">
                                                    <ItemTemplate>
                                                        <div style="padding-left: 10px; right: 10px; right: 10px" align="left">
                                                            ...
                                                            <br />
                                                            <br />
                                                            <asp:Label ID="Label3" ForeColor="Black" class="fontingrid" runat="server" Text="Is File Attached: "
                                                                Font-Bold="True" />
                                                            <asp:Label ID="Label9" ForeColor="Black" class="fontingrid" runat="server" Text='<%#Eval("file_") %>'
                                                                Font-Bold="True" />
                                                        </div>
                                                    </ItemTemplate>
                                                    <HeaderStyle HorizontalAlign="Center" />
