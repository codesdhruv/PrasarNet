<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DashBoard_PBHS.aspx.cs" Inherits="PrasarNet.PBHS.DashBoard_PBHS" MasterPageFile="~/Site1.Master" EnableEventValidation="false" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentSection" runat="server">
    <div class="content gradbody">
        ...
        <div id="divnewapp_link" style="text-align: left; padding-left: 25px; padding-bottom: 10px" runat="server" visible="true">
            ...
            <asp:LinkButton ID="lnknewapplication" ForeColor="Blue" Font-Underline="true" Font-Bold="true" Font-Size="Large" runat="server" Text="New PBHS Application" OnClick="lnknewapplication_Click"></asp:LinkButton>
        </div>
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body grad2 table-responsive">
                        ...
                        <asp:GridView ID="grdapplications" runat="server" AutoGenerateColumns="False" EmptyDataText="..No Records Found.." HorizontalAlign="Center" BackColor="#F8F9F9"
                            DataKeyNames="id" PageSize="20" ShowHeaderWhenEmpty="True" ToolTip="Grievances" AllowPaging="true"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="S.No.">
                                    <ItemTemplate>
                                        <div runat="server" align="center" style="padding: 4px">
                                ...
                                <asp:TemplateField HeaderText="Application Details">
                                    <ItemTemplate>
                                        <div runat="server" align="left" style="padding: 4px">
                                            <asp:Label ID="Label3" Font-Size="Small" runat="server" ForeColor="brown" Text='Application No: ' />
                                            <asp:Label ID="lblappNo" ForeColor="Black" Font-Size="Small" runat="server" Text='<%#Eval("ApplicationNo") %>' />
                                            <br />
                                            <br />
                                            <asp:Label ID="Label4" Font-Size="Small" runat="server" ForeColor="brown" Text='Application Submitted On: ' />
                                            <asp:Label ID="Label9" ForeColor="Black" Font-Size="Small" runat="server" Text='<%#Eval("createdon") %>' />
                                        </div>
                                ...
                                <asp:TemplateField HeaderText="Approved/Issued Status">
                                    <ItemTemplate>
                                        <div runat="server" align="left" style="padding: 4px">
                                            ...
                                            <asp:Label ID="Label18" ForeColor="Black" Font-Size="Small" runat="server" Text='<%#Eval("Cardissued") %>' />
                                        </div>
                                ...
                                <asp:TemplateField HeaderText="Status">
                                    <ItemTemplate>
                                        ...
                                        <div style="padding: 5px" align="center" runat="server">
