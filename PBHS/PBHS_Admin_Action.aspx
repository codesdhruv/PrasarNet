<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PBHS_Admin_Action.aspx.cs" Inherits="PrasarNet.PBHS.PBHS_Admin_Action" MasterPageFile="~/Site1.Master" EnableEventValidation="false" %>
            ...
            <div id="divgrd" visible="true" align="center" class=" col-md-12 col-sm-12 col-lg-12"
                        ...
                        <div class="row" style="margin: auto; padding-left: 20px; padding-right: 20px; padding-bottom: 10px">
                            ...
                            <div id="div26" visible="true" style="padding: 4px;" align="center" class=" col-md-4 col-lg-4"
                                ...
                                <div style="border: thin groove #C0C0C0; padding: 4px;">
                                    ...
                                    <asp:Label ID="lblstatus" runat="server" Text="Status : " CssClass="font2" ForeColor="Brown" Font-Bold="true"></asp:Label>
                                    <br />
                                    <asp:DropDownList ID="ddlstatusfilter" CssClass="txtbx select" runat="server" BackColor="#D6EAF8" Width="70%" Height="30px" ValidationGroup="reg">
                                        <asp:ListItem Value="" Text="All"></asp:ListItem>
                                        <asp:ListItem Value="6" Text="Card Details approved by Welfare"></asp:ListItem>
                                    </asp:DropDownList>
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading grad3">
                        <span style="font-weight: bold; color: Black;" class="font2">:: PBHS Application(s) and their Status ::</span>
                    </div>
                    <div class="panel-body grad2 table-responsive">
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="S.No.">
                                    <ItemTemplate>
                                        <div runat="server" align="center">
                                            ...
                                            <asp:Label ID="Label71" ForeColor="Black" Font-Size="Small" runat="server" Text='<%#Eval("isapproved") %>' Visible="false" />
                                ...
                                <asp:TemplateField HeaderText="Action Taken with Remarks">
                                    <ItemTemplate>
                                        <div align="left" runat="server" style="padding-top: 15px; padding-bottom: 15px; padding-left: 15px; padding-right: 15px">
                                            ...
                                            <asp:LinkButton ID="lblfilefwd2" Font-Bold="true" ToolTip="File Attached" Text="download" CommandArgument='<%#Eval("fileupload") %>' CommandName="downloaddoc" ForeColor="Blue" runat="server" class="fontingrid"></asp:LinkButton>
                                ...
                                <asp:TemplateField HeaderText="Take an Action">
                                    <ItemTemplate>
                                        ...
                                        <div align="center" runat="server" style="padding: 8px">
                                            <asp:Label ID="lblaction1" ForeColor="Red" Font-Bold="true" runat="server" Text='<%#Eval("Cardissued") %>'></asp:Label>
                                            <asp:LinkButton ID="lnkaction" CommandName="takeaction" runat="server" BackColor="#99FFCC" CssClass="btn font2" ForeColor="Black"
                                                CausesValidation="False" Text="Action">
                                            </asp:LinkButton>
                                            <br />
                                ...
                                <asp:TemplateField HeaderText="Final Status">
                                    <ItemTemplate>
                                        ...
                                        <div style="padding: 15px" align="center" runat="server">
                                            ...
                                            <br />
                                            <br />
                                            <asp:LinkButton ID="lnkviewapplication" CommandName="GetaPdf" Font-Underline="true" runat="server" CssClass="fontingrid" ForeColor="Green" Font-Bold="true" Font-Size="Medium"
                                                CausesValidation="False" Text="[View]/ [Print Application]/ [Approved for issuance]">
                                            </asp:LinkButton>
                                            ...
                                            <div id="Div3" runat="server" class="panel-body table-responsive" style="min-height: 400px; margin-top: 10px; margin-bottom: 100px">
                                                ...
                                                <div class="table table-bordered tablecus2" runat="server" style="width: 97%; padding: 10px">
                                                    <asp:Panel ID="panelprint" runat="server">
                                                        ...
                                                        <br />
                                                        <br />
                                                        <div class="header alert-info h1">
                                                        ...
                                                        <div class="header  h2 bg-success bg-warning ">
                                                            <asp:Label ID="Label64" Visible="true" BackColor="YellowGreen" Text="Receipt and Processing of application by the  Welfare section"
                                                                Font-Bold="true" Font-Size="X-Large" runat="server" />
                                                        </div>
                                                        <div class="panel-body" align="left" style="padding: 20px">
                                                            <br />
                                                            <asp:Label ID="Label35" Font-Bold="true" ForeColor="Black" Font-Size="Small" runat="server" Text="The information furnished by the applicant has been approved for issuance of the card.A PBHS Card is ready to be issued to Shri./Smt./Kumari "></asp:Label>
                                                            ...
                                                            <div id="divrmk_approve2" runat="server">
                                                                ...
                                                                <br />
                                                                <asp:Label ID="Label45" Font-Bold="true" ForeColor="Brown" Font-Size="Small" runat="server" Text="Remarks By welfare Section(If Any)"></asp:Label>
                                                                <br />
                                                            ...
                                                            <div id="divapprovebtn2" runat="server" align="center" visible="true">
                                                                <asp:Button ID="btncertify2" OnClick="btncertify2_Click" ValidationGroup="cer1" OnClientClick="return confirm('Are You Sure to approve?');" runat="server" Text="Approve" CssClass="btn" Font-Bold="true" Font-Size="Large" BackColor="#D5F5E3" ForeColor="Black" CausesValidation="False" />
                                                            </div>
                                                            <div id="divapprovemsg2welfare" runat="server" align="left" visible="false">
                                                                <asp:Label ID="lblapprovemsg2welfare" Font-Bold="true" ForeColor="Blue" Font-Size="Small" runat="server" Text=""></asp:Label>
                                                                <br />
                        ...
                        <asp:Panel ID="pnlPopuptrack" runat="server" CssClass="modalPopup scrol" Style="display: none; height: 65%;" Width="80%">
                            ...
                            <asp:UpdatePanel ID="UpdatePaneltrack" runat="server">
                                ...
                                <ContentTemplate>
                                    <div class="header">
                                        <asp:Label ID="Label53" Visible="true" Text="Track PBHS Card Application" Font-Bold="true" Font-Size="Medium" runat="server" />
                                    </div>
                    ...
                    <div id="div22" class="grad2new" runat="server" style="border: medium ridge #000000; padding-top: 20px; padding-bottom: 20px; margin: auto 20px auto 20px">
                        ...
                        <asp:Panel ID="Panel1" runat="server">
                            <asp:CheckBoxList ID="CheckBoxList1" runat="server" AutoPostBack="True" CellPadding="2" class="font2 chk" ForeColor="Black"
                                ...
                                <asp:ListItem Value="3" Enabled="True">&nbsp;&nbsp;Issue Card</asp:ListItem>
                    ...
                    <div id="divforwardedaction" runat="server" visible="false" align="center" style="margin-top: 35px">
                        <div id="div212" runat="server" style="border: medium ridge #000000; padding-top: 20px; padding-bottom: 20px; padding-left: 20px; padding-right: 20px; margin: auto 20px auto 20px">
                            ...
                            <table class="table table table-bordered grad2new def" cellpadding="5" rules="all" style="border-style: ridge; border-width: medium; z-index: 1; position: relative;">
                                <tr class="grad3">
                                    <td align="center" colspan="2" style="padding-top: 8px; padding-bottom: 8px" class="auto-style3">
                                        <asp:Label ID="Label61" runat="server" Text="Card Issue" CssClass="font2" Style="font-weight: bold; color: Black;"></asp:Label>
                                        &nbsp;
                                    </td>
                                </tr>
                                ...
                                <tr class="trnew">
                                    <td align="right" style="padding-right: 10px">
                                        <asp:Button ID="btnfwd" runat="server" Text="Card Issue" Font-Size="Large" class="btn select buttondocumentupload" ValidationGroup="sub1"
                                            Style="background-color: #99FFCC; color: Black; font-weight: bold" OnClick="btnfwd_Click" BorderColor="Black" BorderStyle="Ridge" BorderWidth="2px" Width="170px" />
                                    </td>
                                    <td align="left" style="padding-left: 10px">
