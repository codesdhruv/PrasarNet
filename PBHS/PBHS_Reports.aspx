<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PBHS_Reports.aspx.cs" Inherits="PrasarNet.PBHS.PBHS_Reports" MasterPageFile="~/Site1.Master" EnableEventValidation="false" %>
    ...
    <div class="content gradbody">
        ...
        <div class="row" style="margin: auto; padding: 10px; background-color: #66CCFF;">
            <div id="Div15" class="col-md-12 col-sm-12 col-lg-12" runat="server" align="center">
                ...
                <asp:Label ID="Label16" runat="server" Text="::PBHS Reports::" Style="font-weight: 700; font-size: x-large; color: #000000"></asp:Label>
                <br />
            </div>
        </div>
        <div class="row" style="margin: auto; padding: 10px">
                    ...
                    <fieldset id="Fieldset1" runat="server" style="border: medium ridge #808080;">
                        ...
                        <div class="row" style="margin: auto; padding-left: 20px; padding-right: 20px; padding-bottom: 10px">
                            ...
                            <div id="div23" visible="true" style="padding: 4px;" align="center" class=" col-md-3 col-lg-3"
                                runat="server">
                                <div style="border: thin groove #C0C0C0; padding: 4px;">
                                    <asp:Label ID="Label83" runat="server" Text="Date of Application(From) " CssClass="font2" ForeColor="Brown" Font-Bold="true"></asp:Label>
                                    <br />
                            ...
                            <div id="div25" visible="true" style="padding: 4px;" align="center" class=" col-md-3 col-lg-3"
                                runat="server">
                                <div style="border: thin groove #C0C0C0; padding: 4px;">
                                    <asp:Label ID="Label89" runat="server" Text="Date of Application(To) " CssClass="font2" ForeColor="Brown" Font-Bold="true"></asp:Label>
                                    <br />
                        ...
                        <div class="row" style="margin: auto; padding-left: 20px; padding-right: 20px; padding-bottom: 10px">
                            <div id="div6" visible="true" style="padding: 4px;" align="center" class="col-md-3 col-lg-3"
                                runat="server">
                                <div style="border: thin groove #C0C0C0; padding: 4px;">
                                    <asp:Label ID="Label3" runat="server" Text="Is Applicant's Information Approved? " CssClass="font2" ForeColor="Brown" Font-Bold="true"></asp:Label>
                                    <br />
                                    <asp:DropDownList ID="ddlisapproved" CssClass="txtbx select" runat="server" BackColor="#D6EAF8" Width="70%" Height="30px" ValidationGroup="reg">
                            ...
                            <div id="div8" visible="true" style="padding: 4px;" align="center" class="col-md-3 col-lg-3"
                                runat="server">
                                <div style="border: thin groove #C0C0C0; padding: 4px;">
                                    <asp:Label ID="Label9" runat="server" Text="Status of Card " CssClass="font2" ForeColor="Brown" Font-Bold="true"></asp:Label>
                                    <br />
                                    <asp:DropDownList ID="ddlstatus" CssClass="txtbx select" runat="server" BackColor="#D6EAF8" Width="70%" Height="30px" ValidationGroup="reg">
                                        <asp:ListItem Value="" Text="All"></asp:ListItem>
                                        <asp:ListItem Value="1" Text="Card Issued"></asp:ListItem>
                                        <asp:ListItem Value="0" Text="Card Request Rejected"></asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                            </div>

                            <div id="div12" visible="true" style="padding: 4px;" align="center" class=" col-md-3 col-lg-3"
                                runat="server">
                                <div style="border: thin groove #C0C0C0; padding: 4px;">
                                    <asp:Label ID="Label18" runat="server" Text="Application No " CssClass="font2" ForeColor="Brown" Font-Bold="true"></asp:Label>
                                    <br />
                                    <asp:TextBox ID="txtappno" CssClass="txtbx select padtxt" Font-Size="Small" runat="server" Width="70%" Height="30px" BackColor="#D6EAF8" AutoComplete="Off"></asp:TextBox>
                                </div>
                            </div>
                            <div id="div4m" visible="true" style="padding: 4px;" align="center" class=" col-md-3 col-lg-3"
                                runat="server">
                                <div style="border: thin groove #C0C0C0; padding: 4px;">
                                    <asp:Label ID="Label35" runat="server" Text="Applicant's Name " CssClass="font2" ForeColor="Brown" Font-Bold="true"></asp:Label>
                                    <br />
                                    <asp:TextBox ID="txtnameapplicant" CssClass="txtbx select padtxt" Font-Size="Small" runat="server" Width="70%" Height="30px" BackColor="#D6EAF8" AutoComplete="Off"></asp:TextBox>
                                </div>
                            </div>
                        </div>
        ...
        <div id="divgrdreports" runat="server" visible="false">
            <div id="divtransferStats" visible="false" runat="server" align="center" style="border: medium ridge #000000; margin: 0 20px 10px 20px;">
                <div runat="server" align="center" style="padding: 7px">
                    <asp:Label runat="server" ID="lblmsg" CssClass="font2" ForeColor="Black" Font-Underline="true" Font-Bold="true" Text="PBHS Recieved Application Statistics"></asp:Label>
                </div>
                ...
                <div class="row" runat="server" align="center" style="margin: auto; padding-top: 7px; padding-bottom: 7px; padding-right: 0px; padding-left: 0px; align-items: center">
                    ...
                    <div align="center" runat="server" class="col-md-4 col-sm-4 col-lg-4" style="padding-top: 5px; padding-bottom: 5px">
                       ...
                       <div align="center" runat="server" class="col-md-4 col-sm-4 col-lg-4" style="padding-top: 5px; padding-bottom: 5px">
                        ...
                        <asp:Button ID="btnapprovedwelfare" runat="server" class="gradcured font2" Font-Bold="true"
                            Style="padding-top: 63px; padding-bottom: 62px; width: 70%; height: 150px;" BorderColor="White" OnClick="btnapprovedwelfare_Click" />

                       
                    </div>
                     <div align="center" runat="server" class="col-md-4 col-sm-4 col-lg-4" style="padding-top: 5px; padding-bottom: 5px">
                        
                        <asp:Button ID="btncardissued" runat="server" class="gradbody21 font2" Font-Bold="true"
                            Style="padding-top: 63px; padding-bottom: 62px; width: 70%; height: 150px;" BorderColor="White" OnClick="btncardissued_Click" />

                       
                    </div>
                     <div align="center" runat="server" class="col-md-4 col-sm-4 col-lg-4" style="padding-top: 5px; padding-bottom: 5px">
                        
                        <asp:Button ID="btnapprovedbyhoo" runat="server" class="grad5 font2" Font-Bold="true"
                            Style="padding-top: 63px; padding-bottom: 62px; width: 70%; height: 150px;" BorderColor="White" OnClick="btnapprovedbyhoo_Click" />
                        ...
                        <div align="center" class=" col-md-12 col-sm-12 col-lg-12" style="padding: 7px; margin: 3px">
                            <div class="panel panel-primary">
                                <div class="panel-heading grad3" align="center">
                                    <span style="font-weight: bold; color: Black;" class="font2">:: Details of PBHS Recieved Application(s) with their Status ::</span>
                                </div>
                                <div class="panel-body grad2 table-responsive">
                                    <div id="divprisearch" style="text-align: center" runat="server" visible="true">
                                            ...
                                            <tr>
                                                <td align="center" style="padding: 10px">
                                                    <asp:LinkButton ID="btnprint1" runat="server" CssClass="btn" CausesValidation="False" BorderColor="Black" BorderStyle="Ridge" BorderWidth="2px" Width="200px"
                                                        BackColor="#F5B7B1" OnClick="btnprint1_Click" ToolTip="Print">
                                        ...
                                        <table width="100%">
                                            <tr>
                                                <td align="center" style="padding: 10px">
                                                    <asp:LinkButton ID="lnkExporttoExcel" runat="server" CssClass="btn" CausesValidation="False" BorderColor="Black" BorderStyle="Ridge" BorderWidth="2px" Width="200px" Visible="false"
                                                        BackColor="#82E0AA"  ToolTip="Export to Excel" OnClick="lnkExporttoExcel_Click">
                                                    ...
                                                    <td align="center" style="padding: 10px">
                                                    <asp:LinkButton ID="lnkBulkphotu" runat="server" CssClass="btn" CausesValidation="False" BorderColor="Black" BorderStyle="Ridge" BorderWidth="2px" Width="200px" Visible="false"
                                                        BackColor="#82E0AA"  ToolTip="Photu download in Bulk" OnClick="lnkbulkphotu_Click">
                                                        <span aria-hidden="true" style="color: Black" class="glyphicon glyphicon-list-alt"></span>
                                                        <span style="font-weight: bold; color: #b200ff">Photu download in Bulk</span></asp:LinkButton>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
                                    ...
                                    <div runat="server" id="pnlprint">
                                        ...
                                        <div id="div36" style="text-align: center; padding: 10px; margin: auto" runat="server" visible="true" class="row">
                                            ...
                                            <div class="col-lg-3 col-md-3" style="padding: 7px">
                                        ...
                                        <asp:GridView ID="grdapplications" runat="server" AutoGenerateColumns="False" EmptyDataText="..No Records Found.." HorizontalAlign="Center" BackColor="#F8F9F9"
                                            DataKeyNames="id" ShowHeaderWhenEmpty="True" ToolTip="PBHS Application Recieved" AllowPaging="true"
                                            Width="98%" OnPageIndexChanging="grdapplications_PageIndexChanging" OnRowCommand="grdapplications_RowCommand">
                                                ...
                                                <asp:TemplateField HeaderText="Approved/Issued Status">
                                                    <ItemTemplate>
                                                        <div runat="server" align="left" style="padding: 15px">
                                                            ...
                                                            <br />
                                                            <br />
                                                            <asp:Label ID="Label26" Font-Size="Small" runat="server" ForeColor="brown" Text='Application Approved On: ' />
                                                            <asp:Label ID="Label27" ForeColor="Black" Font-Size="Small" runat="server" Text='<%#Eval("approvedon") %>' />
                                                            <br />
                                                            <br />
                                                            ...
                                                            <%-- <br />
                                                            <br />
                                                            <asp:Label ID="Label23" Font-Bold="true" ForeColor="Brown" runat="server" Text=" Card No: " class="fontingrid" Font-Size="Small" />
                                                            <asp:Label ID="Label24" Font-Bold="true" ForeColor="Black" runat="server" Text='<%#Eval("DesignationName") %>' Font-Size="Small" />--%>
                                                            <br />
                                                            <br />
                                                            <asp:Label ID="Label11" Font-Bold="true" ForeColor="Brown" runat="server" Text="Family Members to whom card has been issued : " class="fontingrid" Font-Size="Small" />
                                                            <asp:Label ID="Label28" Font-Bold="true" ForeColor="Black" runat="server" Text='<%#Eval("beneficiary") %>' Font-Size="Small" />
                                ...
                                <asp:PostBackTrigger ControlID="grdcerprev" />--%>
                                    ...
                                    <asp:Panel ID="pnlPopuptrack" runat="server" CssClass="modalPopup scrol" Style="display: none; height: 65%;" Width="80%">
                                        ...
                                        <asp:UpdatePanel ID="UpdatePaneltrack" runat="server">
                                            <ContentTemplate>
                                                <div class="header">
                                                    <asp:Label ID="Label53" Visible="true" Text="Track Your PBHS Application" Font-Bold="true" Font-Size="Medium" runat="server" />
                                                </div>
                                                        ...
                                                        <asp:GridView ID="grdtrack" runat="server" AutoGenerateColumns="False" AllowPaging="false" ToolTip="Track Application"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Dealing Section/Station/Officer" Visible="false">
                                                                    <ItemTemplate>
                                                                        <div style="padding-left: 10px; right: 10px" align="left">
                                                                            <asp:Label ID="Label43" Font-Bold="true" ForeColor="Brown" runat="server" Text="Section/Station/Officer: " class="fontingrid" />
                                                                            <asp:Label ID="Label44" ForeColor="Black" class="fontingrid" runat="server" Text='<%#Eval("DealingOffc") %>'
                                                                                Font-Bold="True" />
                                                                            <br />
                                                                            <asp:Label ID="Label45" Font-Bold="true" ForeColor="Brown" runat="server" Text="Recieved On: " class="fontingrid" />
                                                                            <asp:Label ID="Label46" ForeColor="Black" class="fontingrid" runat="server" Text='<%#Eval("AppSubmitOn") %>'
                                                                                Font-Bold="True" />
                                                                        </div>
                                                                    </ItemTemplate>
                                                                    <HeaderStyle HorizontalAlign="Center" />
                                                                ...
                                                                <asp:TemplateField HeaderText="Forward/Closed with Remarks">
                                                                    <ItemTemplate>
                                                                        <div style="padding-left: 10px; right: 10px; right: 10px" align="left">
                                                                            ...
                                                                            <br />
                                                                            <br />
                                                                            <asp:Label ID="Label47" ForeColor="Black" class="fontingrid" runat="server" Text="Is File Attached: "
                                                                                Font-Bold="True" />
                                                                            <asp:Label ID="Label48" ForeColor="Black" class="fontingrid" runat="server" Text='<%#Eval("file_") %>'
                                                                                Font-Bold="True" />
                                                                        </div>
                                                                    </ItemTemplate>
                                                                    <HeaderStyle HorizontalAlign="Center" />
