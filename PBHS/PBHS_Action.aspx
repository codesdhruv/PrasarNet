<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PBHS_Action.aspx.cs" Inherits="PrasarNet.PBHS.PBHS_Action" Title="PBHS-Action" MasterPageFile="~/Site1.Master" EnableEventValidation="false" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentSection" runat="server">
    <div class="content gradbody">
        ...
        <div id="Div1" class="col-md-12 col-sm-12 col-lg-12" runat="server" align="right">
            ...
            <br />
            <br />
            <div class="style1" style="text-align: left; padding-top: 5px; padding-right: 10px; padding-left: 60px; padding-bottom: 0px">
            ...
            <div id="divnewapp_link" style="border: medium ridge #808080; text-align: left; margin: 50px; padding: 50px" runat="server" visible="true" class="grad5">
                <asp:LinkButton ID="lnknewapplication" class="font2" ForeColor="Blue" Font-Underline="true" Font-Bold="true" runat="server" Text="1. Apply/View PBHS Card Application" OnClick="lnknewapplication_Click"></asp:LinkButton>
                <br />
                <br />
                <br />
                <asp:LinkButton ID="lnktakeanaction" class="font2" ForeColor="Blue" Font-Underline="true" Font-Bold="true" runat="server" Text="2. Verify the Details of Applicant(s)" OnClick="lnktakeanaction_Click"></asp:LinkButton>
                &nbsp;<asp:Label ID="lblactiontobetaken" runat="server" Style="font-weight: 700; font-size: medium; color: #FF0000" Text=""></asp:Label>
                <br />
                <br />
                <br />
                <asp:LinkButton ID="lnk_actiontaken_" class="font2" ForeColor="Blue" Font-Underline="true" Font-Bold="true" runat="server" Text="3. Applicant(s) Details has already been Verified" OnClick="lnk_actiontaken__Click"></asp:LinkButton>
