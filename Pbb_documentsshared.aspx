<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pbb_documentsshared.aspx.cs" Inherits="PrasarNet.Pbb_documentsshared"
                                ...
                                <asp:TemplateField HeaderText="Shared Document(s) Information">
                                    <itemtemplate>
                                        <div style="padding: 10px">
                                            ...
                                            <br />
                                            <asp:Label ID="Label9" runat="server" Text="Extension" class="font2" Font-Bold="true"
                                                ForeColor="Maroon" />
                                            <asp:Label ID="Label12" runat="server" Text=": " class="font2" Font-Bold="true" />
                                            <asp:Label ID="Label13" runat="server" ForeColor="Black"
                                                Font-Underline="false" Text='<%#Eval("Docextension") %>' class="font2" Font-Bold="True"
                                                CausesValidation="False" />
                                            <br />
