<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Reports.aspx.cs" Inherits="PrasarNet.Transfer_M.Reports" MasterPageFile="~/Site1.Master" EnableEventValidation="false" %>
    ...
    <div class="content gradbody">
        ...
        <div id="Div1" class="col-md-12 col-sm-12 col-lg-12" runat="server" align="right">
            ...
            <div id="divnewapp_link" style="border: medium ridge #808080; text-align: left; margin: 50px; padding: 50px" runat="server" visible="true" class="grad5">
                <asp:LinkButton ID="lnkTransferreports" class="font2" ForeColor="Blue" Font-Underline="true" Font-Bold="true" runat="server" Text="TRAM Reports" OnClick="lnkTransferreports_Click" ToolTip="TRAM Reports"></asp:LinkButton>
                <br />
