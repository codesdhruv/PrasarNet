<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Transfer.aspx.cs" Inherits="PrasarNet.Transfer_M.Transfer" MasterPageFile="~/Site1.Master" EnableEventValidation="false" %>
    ...
    <div class="content gradbody">
        ...
        <div id="Div1" class="col-md-12 col-sm-12 col-lg-12" runat="server" align="right">
            ...
            <%--<div class="style1" style="text-align: center">
                <marquee direction="left" scrolldelay="122" behavior="slide" style="font-weight: 700; font-size: large; color: #FF0000; background-color: #CCFFFF">
                    <strong>This module is under development/testing, All data/record is for test only * यह मॉड्यूल निर्माणाधीन/परीक्षणाधीन है, सभी डेटा / रिकॉर्ड केवल परीक्षण के लिए है |
                    &nbsp;&nbsp;&nbsp; 
                        <br class="style3">
                    </strong></marquee>
            </div>--%>
            <div class="style1" style="text-align: left; padding-top: 15px; padding-right: 10px; padding-left: 60px; padding-bottom: 0px">
                <%--<marquee direction="left" scrolldelay="122" behavior="slide" style="font-weight: 700; font-size: large; color: #FF0000; background-color: #CCFFFF">
                    <strong>This module is under development/testing, All data/record is for test only * यह मॉड्यूल निर्माणाधीन/परीक्षणाधीन है, सभी डेटा / रिकॉर्ड केवल परीक्षण के लिए है |
                    &nbsp;&nbsp;&nbsp; 
                        <br class="style3">
                    </strong></marquee>--%>
                <asp:LinkButton ID="lnkdownload" runat="server" CausesValidation="False" font-size="Large" OnClick="lnkdownload_Click" Font-Underline="True">
                    <span style="font-weight: bold; color: blue">Download Help File</span></asp:LinkButton>
            </div>
            <div id="divnewapp_link" style="border: medium ridge #808080; text-align: left; margin: 20px; padding: 50px" runat="server" visible="true" class="grad5">
                <asp:LinkButton ID="lnknewapplication" class="font2" ForeColor="Blue" Font-Underline="true" Font-Bold="true" runat="server" Text="1. Apply/View Transfer Application(s)" OnClick="lnknewapplication_Click"></asp:LinkButton>
                <br />
                <br />
                <br />
                <asp:LinkButton ID="lnktakeanaction" class="font2" ForeColor="Blue" Font-Underline="true" Font-Bold="true" runat="server" Text="2. Take an action on Applicant(s) Transfer Request(s)" OnClick="lnktakeanaction_Click"></asp:LinkButton>
                &nbsp;<asp:Label ID="lblactiontobetaken" runat="server" style="font-weight: 700; font-size: medium; color: #FF0000" Text=""></asp:Label>
                <br />
                <br />
                <br />
                <asp:LinkButton ID="lnk_actiontaken_" class="font2" ForeColor="Blue" Font-Underline="true" Font-Bold="true" runat="server" Text="3. Application(s) on which action has been taken" OnClick="lnk_actiontaken__Click"></asp:LinkButton>

                &nbsp;<asp:Label ID="lblactionalreadytaken" runat="server" style="font-weight: 700; font-size: medium; color: #009900" Text=""></asp:Label>
