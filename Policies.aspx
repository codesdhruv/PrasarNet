<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Policies.aspx.cs" Inherits="PrasarNet.Policies"
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentSection" runat="server">
    <div class="content gradbody containerh">
        ...
        <div id="Div9" class="col-md-12 col-sm-12 col-lg-12" runat="server" align="right">
            <br />
            <asp:LinkButton ID="btnhome" runat="server" BorderColor="Black" BorderStyle="Ridge" BorderWidth="1px" CssClass="btn grad4" CausesValidation="False" OnClick="btnhome_Click"><span aria-hidden="true" style="color: Black" class="glyphicon glyphicon-home"></span>&nbsp; <span style="font-weight: bold; color: #000000">Home</span></asp:LinkButton>
            <br />
            <br />
        </div>
        <div class="row" style="margin: auto;">
            <div align="center" class="col-md-4 col-sm-4 col-xs-12 col-lg-3 padd" runat="server"
                ...
                <div class="grad5 table-responsive" style="padding: 20px">
                    <div id="Div1" runat="server" align="center" class="grad3" style="padding-top: 4px; padding-bottom: 4px">
                        <asp:Label ID="Label4" runat="server" Text="Select Policy Category" Style="font-weight: bold; font-size: medium; color: Black;"></asp:Label>
                        &nbsp;
                    </div>
                    <div id="divcat" runat="server" style="padding-top: 20px; padding-bottom: 20px; padding-left: 8px; padding-right: 8px">
                        <asp:RadioButtonList ID="rblpoltyp" Style="margin-right: 15px" runat="server" AutoPostBack="True"
                            CellPadding="10" CellSpacing="10" RepeatDirection="Vertical" EnableTheming="False"
                            Font-Bold="True" Font-Overline="True" class="font2" OnSelectedIndexChanged="rblpoltyp_SelectedIndexChanged"
                            Font-Names="nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;">
                        </asp:RadioButtonList>
                    </div>
                </div>
            </div>
            <div align="center" class=" col-md-8 col-sm-8 col-xs-12 col-lg-9" runat="server"
                style="padding-top: 15px; padding-left: 20px; padding-right: 20px" id="divgrd">
                    ...
                    <div class="panel-body grad2 table-responsive">
                        <div class="row" id="divshow" runat="server">
                            <div style="padding-left: 50px" class="col-md-6 col-sm-6 col-xs-12 col-lg-6">
                                <asp:Label ID="Label5" runat="server" class="font2 pull-left" Text="Selected Policy Category: "
                        ...
                        <asp:GridView ID="grdpolicy" runat="server" DataKeyNames="Policyid" AutoGenerateColumns="False"
                            ...
                            HeaderStyle-ForeColor="White" EmptyDataText=".. Records Not Found .." ShowHeaderWhenEmpty="True"
                            Width="70%" OnPageIndexChanging="grdpolicy_PageIndexChanging" OnRowCommand="grdpolicy_RowCommand"
                            ...
                            <columns>
                                ...
                                <asp:TemplateField HeaderText="Title/Subject">
                                    <itemtemplate>
                                ...
                                <asp:TemplateField HeaderText="Policy No">
                                    <itemtemplate>
                                        <asp:Label ID="Label3" runat="server" Text='<%#Eval("policyno") %>' class="fontingrid" />
                                    </itemtemplate>
                                    <itemstyle horizontalalign="Center" />
                                    <headerstyle horizontalalign="Center" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Dated">
                                    <itemtemplate>
                                        <asp:Label ID="Label8" runat="server" Text='<%#Eval("Dated") %>' class="fontingrid" />
                                    </itemtemplate>
                                    <itemstyle horizontalalign="Center" />
                                    <headerstyle horizontalalign="Center" />
                                </asp:TemplateField>
