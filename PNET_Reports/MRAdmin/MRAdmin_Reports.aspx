<%@ Page Title="" Language="C#" MasterPageFile="~/PNET_Reports/MRAdmin/MRAdmin.Master" AutoEventWireup="true" CodeBehind="MRAdmin_Reports.aspx.cs" Inherits="PrasarNet.PNET_Reports.MRAdmin.WebForm1" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <ContentTemplate>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                ...
                                <nav id="breadcrumbs">
                                    <ul>
                                        <li><asp:Button ID="btnexcel" runat="server" Text="Export to Excel" CssClass="btncolor" OnClick="btnexcel_Click" /></li>
                                        <li></li>
                                        <li><asp:Button ID="brnpdf" runat="server" Text="Export to PDF" CssClass="btncolor" OnClick="brnpdf_Click" /></li>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="row col-lg-12" style="margin-top: 0px;overflow:auto;">
                                                    ...
                                                    <asp:GridView ID="Gridrpt" runat="server" Width="100%" CssClass="table">
                                                        ...
                                                        <HeaderStyle BackColor="#337585" Font-Bold="True" ForeColor="black" HorizontalAlign="Center" VerticalAlign="Middle" Height="30px" />
         ...
         <Triggers>
            ...
            <asp:PostBackTrigger ControlID="brnpdf" />
