...
namespace PrasarNet.PNET_Reports.MRAdmin
{
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        string query;
        string Para_year, Para_month, Para_zone, Para_state, Para_stnid, Para_Report_Id, Para_Services = "";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                if (!string.IsNullOrEmpty(Request.ServerVariables["HTTP_REFERER"]))
                {
                    try
                    {
                        if (Session["isLogin"].ToString() != null)
                        {
                            fillReportType();
                            fillyear();
                            fillmonth();
                            ...
                            ddlstation.Items.Insert(0, new System.Web.UI.WebControls.ListItem("---Select Station---", "0"));
                ...
                using (SqlCommand cmd = new SqlCommand("PN18_MR_sp_Reporttype", conn))
                {
                    ...
                    using (SqlDataAdapter adap = new SqlDataAdapter(cmd))
                    {
                        ...
                        if (ds.Tables[0].Rows.Count > 0)
                        {
                            ...
                            //ddlreporttype.Items.Add(new System.Web.UI.WebControls.ListItem("---Select Report Type---", "0"));
                            ddlreporttype.Items.Insert(0, new System.Web.UI.WebControls.ListItem("---Select Report Type---", "0"));
        ...
        private void fillAllORGStations()
        {
            using (SqlConnection conn = new SqlConnection(con))
            {
                ...
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@Action", "o");
                    ...
                    using (SqlDataAdapter adap = new SqlDataAdapter(cmd))
                    {
                        ...
                        if (ds.Tables[0].Rows.Count > 0)
                        {
                            ...
                            //ddlstation.Items.Add(new System.Web.UI.WebControls.ListItem("---Select Station---", "0"));
                            ddlstation.Items.Insert(0, new System.Web.UI.WebControls.ListItem("---Select Station---", "0"));
                ...
                using (SqlCommand cmd = new SqlCommand("PN18_MR_sp_Zones", conn))
                {
                    ...
                    using (SqlDataAdapter adap = new SqlDataAdapter(cmd))
                    {
                        ...
                        if (ds.Tables[0].Rows.Count > 0)
                        {
                            ...
                            ddlzone.DataBind();
                            ddlzone.Items.Insert(0, new System.Web.UI.WebControls.ListItem("---Select Zone---", "0"));
                        }
        ...
        private void fillstatewisestation()
        {
            using (SqlConnection conn = new SqlConnection(con))
            {
                using (SqlCommand cmd = new SqlCommand("PN18_MR_sp_AllStations_LoginStations", conn))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@Action", "SALLSWISE");
                    //cmd.Parameters.AddWithValue("@OrganizationID", Session["Orgid"].ToString());
                    cmd.Parameters.AddWithValue("@pStateId", ddlstate.SelectedValue.ToString());
        ...
        private void fillReport()
        {
            ...
            if (ddlreporttype.SelectedValue.ToString() == "1000")
            {
                ...
                if (ddlzone.SelectedIndex > 0)
                    Para_zone = " AND MR_HPT.IT_ZONEID=" + ddlzone.SelectedValue.ToString() + "";
                ...
                if (ddlstate.SelectedIndex > 0)
                    Para_state = " AND MR_HPT.StateID=" + ddlstate.SelectedValue.ToString() + "";
                ...
                if (ddlstation.SelectedIndex > 0)
                    Para_stnid = " AND MR_HPT.StationID=" + ddlstation.SelectedValue.ToString() + "";
                else
                    Para_stnid = "";

                string Para_Report_Id = "";
                if (ddlreporttype.SelectedIndex > 0)
                    Para_Report_Id = " AND MR_HPT.Report_Id=" + ddlreporttype.SelectedValue.ToString() + "";
                else
                    Para_Report_Id = "";
                ...
                query = @"SELECT distinct  MR_Year.Year_NM as 'Year', MR_Month.Month_Nm as 'Month', MR_HPT.Station as 'Station', HRIS.dbo.IT_ZONE1.ZoneName as 'Zone',HRIS.dbo.LKP_State.StateName as 'State',HRIS.dbo.MST_Station.StationName 'Station Name', MR_Services.Services_Name as 'Services',  MR_HPT.MonthlySchdProghrs as 'Monthly Scheduled Prog(Hrs.)',  MR_HPT.ActualProghrs as 'Actual Prog(Hrs.)', 
					   ...
					   MR_ReportType ON MR_HPT.Report_Id = MR_ReportType.Report_Id INNER JOIN
                       ...
                       " " + Para_year + " " + Para_month + " " + Para_zone + " " + Para_state + " " + Para_stnid + " " + Para_Report_Id + " " + Para_Services + "  order by MR_HPT.Inserted_Dt desc";
            }
            ...
            else if (ddlreporttype.SelectedValue.ToString() == "1001")
            {
                ...
                //string Para_zone = "";
                if (ddlzone.SelectedIndex > 0)
                    Para_zone = " AND MR_Studiosetup.IT_ZONEID=" + ddlzone.SelectedValue.ToString() + "";
                ...
                //string Para_state = "";
                if (ddlstate.SelectedIndex > 0)
                    Para_state = " AND MR_Studiosetup.StateID=" + ddlstate.SelectedValue.ToString() + "";
                ...
                //string Para_stnid = "";
                if (ddlstation.SelectedIndex > 0)
                    Para_stnid = " AND MR_Studiosetup.StationID=" + ddlstation.SelectedValue.ToString() + "";
                else
                    Para_stnid = "";

                //string Para_Report_Id = "";
                if (ddlreporttype.SelectedIndex > 0)
                    Para_Report_Id = " AND MR_Studiosetup.Report_Id=" + ddlreporttype.SelectedValue.ToString() + "";
                else
                    Para_Report_Id = "";

                //string Para_Services = "";
                //if (ddlservices.SelectedIndex > 0)
                //    Para_Services = " AND MR_Studiosetup.Services_ID=" + ddlservices.SelectedValue.ToString() + "";
                ...
                query = @"SELECT distinct MR_Studiosetup.Slno,MR_Studiosetup.Year_ID,MR_Year.Year_NM as 'Year',MR_Studiosetup.Month_ID, MR_Month.Month_Nm as 'Month', HRIS.dbo.IT_ZONE1.ZoneName as 'Zone',HRIS.dbo.LKP_State.StateName as 'State',HRIS.dbo.MST_Station.StationName 'Station Name',	   
					    ...
					    where HRIS.dbo.IT_ZONE1.WingID=1" +
                       " " + Para_year + " " + Para_month + " " + Para_zone + " " + Para_state + " " + Para_stnid + " " + Para_Report_Id + "  order by MR_Studiosetup.Inserted_Dt desc";
            }
            else if (ddlreporttype.SelectedValue.ToString() == "1002")
            {
                ...
                //string Para_zone = "";
                if (ddlzone.SelectedIndex > 0)
                    Para_zone = " AND MR_DSNG.IT_ZONEID=" + ddlzone.SelectedValue.ToString() + "";
                ...
                //string Para_state = "";
                if (ddlstate.SelectedIndex > 0)
                    Para_state = " AND MR_DSNG.StateID=" + ddlstate.SelectedValue.ToString() + "";
                ...
                //string Para_stnid = "";
                if (ddlstation.SelectedIndex > 0)
                    Para_stnid = " AND MR_DSNG.StationID=" + ddlstation.SelectedValue.ToString() + "";
                else
                    Para_stnid = "";

                //string Para_Report_Id = "";
                if (ddlreporttype.SelectedIndex > 0)
                    Para_Report_Id = " AND MR_DSNG.Report_Id=" + ddlreporttype.SelectedValue.ToString() + "";
                else
                    Para_Report_Id = "";
                ...
                query = @"SELECT distinct MR_DSNG.Slno,MR_DSNG.Year_ID,MR_Year.Year_NM as 'Year',MR_DSNG.Month_ID, MR_Month.Month_Nm as 'Month', HRIS.dbo.IT_ZONE1.ZoneName as 'Zone',HRIS.dbo.LKP_State.StateName as 'State',HRIS.dbo.MST_Station.StationName 'Station Name',	   
					    ...
					    where HRIS.dbo.IT_ZONE1.WingID=1" +
                       " " + Para_year + " " + Para_month + " " + Para_zone + " " + Para_state + " " + Para_stnid + " " + Para_Report_Id + "  order by MR_DSNG.Inserted_Dt desc";
            }
            else
            {
            }
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                if (ddlreporttype.SelectedValue.ToString() == "1001")
                {
                    ...
                    string Para_yearner = "";
                    if (ddlyear.SelectedIndex > 0)
                        Para_yearner = " AND MR_StudioNewEquipReceived.Year_ID=" + ddlyear.SelectedValue.ToString() + "";
                    else
                        Para_yearner = "";

                    string Para_monthner = "";
                    if (ddlmonth.SelectedIndex > 0)
                        Para_monthner = " AND MR_StudioNewEquipReceived.Month_ID=" + ddlmonth.SelectedValue.ToString() + "";
                    ...
                    string Para_zonener = "";
                    if (ddlzone.SelectedIndex > 0)
                        Para_zonener = " AND MR_StudioNewEquipReceived.IT_ZONEID=" + ddlzone.SelectedValue.ToString() + "";

                    else
                        Para_zonener = "";

                    string Para_statener = "";
                    if (ddlstate.SelectedIndex > 0)
                        Para_statener = " AND MR_StudioNewEquipReceived.StateID=" + ddlstate.SelectedValue.ToString() + "";

                    else
                        Para_statener = "";

                    string Para_stnidner = "";
                    if (ddlstation.SelectedIndex > 0)
                        Para_stnidner = " AND MR_StudioNewEquipReceived.StationID=" + ddlstation.SelectedValue.ToString() + "";
                    else
                        Para_stnidner = "";

                    string queryner = @"select EquipmentID,MR_StudioNewEquipReceived.Year_ID,MR_StudioNewEquipReceived.Month_ID,MR_StudioNewEquipReceived.IT_ZONEID,MR_StudioNewEquipReceived.StateId,MR_StudioNewEquipReceived.StationID,Equip_Type,Equipment_NM,Equipment_Performance,
                                 CASE WHEN Dt_Installtion IS NOT NULL AND Dt_Installtion ! = '' THEN CONVERT(VARCHAR(11), Dt_Installtion, 103) ELSE NULL END as Dt_Installtion,
                                 Equip_Status,Equip_Rating,Equip_Make,Equip_Model,Equip_Serialno from MR_StudioNewEquipReceived INNER JOIN
                                 MR_Year ON MR_StudioNewEquipReceived.Year_ID = MR_Year.Year_ID INNER JOIN
                                 MR_Month ON MR_StudioNewEquipReceived.Month_ID = MR_Month.Month_ID INNER JOIN
                                 HRIS.dbo.IT_ZONE1 ON MR_StudioNewEquipReceived.IT_ZONEID = HRIS.dbo.IT_ZONE1.IT_ZONEID INNER JOIN
                                 HRIS.dbo.LKP_State ON MR_StudioNewEquipReceived.StateId = HRIS.dbo.LKP_State.StateId INNER JOIN
                                 HRIS.dbo.MST_Station ON MR_StudioNewEquipReceived.StationID = HRIS.dbo.MST_Station.StationID 

					           where HRIS.dbo.IT_ZONE1.WingID=1" +
                           " " + Para_yearner + " " + Para_monthner + " " + Para_zonener + " " + Para_statener + " " + Para_stnidner + " ";

                    List<string> itemListner = new List<string>();

                    using (SqlDataAdapter adapner = new SqlDataAdapter(queryner, con))
                    {
                        DataSet dsner = new DataSet();
                        adapner.Fill(dsner);
                        if (dsner.Tables[0].Rows.Count > 0)
                        {
                            Gridnewequiprec.DataSource = dsner;
                            ...
                            for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                            {
                                ...
                                for (int j = 0; j < dsner.Tables[0].Rows.Count; j++)
                                {
                                    lblneweqip.Text = "";

                                    if ((ds.Tables[0].Rows[i]["Year_ID"].ToString() == dsner.Tables[0].Rows[j]["Year_ID"].ToString()) && (ds.Tables[0].Rows[i]["Month_ID"].ToString() == dsner.Tables[0].Rows[j]["Month_ID"].ToString()))
                                    {

                                        itemListner.Add(dsner.Tables[0].Rows[j]["Equipment_NM"] + "|" + dsner.Tables[0].Rows[j]["Equipment_Performance"] + "|" + dsner.Tables[0].Rows[j]["Dt_Installtion"] + "|" + dsner.Tables[0].Rows[j]["Equip_Rating"] + "|" + dsner.Tables[0].Rows[j]["Equip_Make"] + "|" + dsner.Tables[0].Rows[j]["Equip_Model"] + "|" + dsner.Tables[0].Rows[j]["Equip_Serialno"]);

                                    }



                                    foreach (var itemner in itemListner)
                                    {
                                        lblneweqip.Text = string.Join("\n", itemListner.Cast<string>());
                        ...
                        {
                            dsner.Tables[0].Rows.Add(dsner.Tables[0].NewRow());
                            Gridnewequiprec.DataSource = dsner;
                            Gridnewequiprec.DataBind();
                    ...
                    string Para_yearacp = "";
                    if (ddlyear.SelectedIndex > 0)
                        Para_yearacp = " AND MR_StudioACPlant.Year_ID=" + ddlyear.SelectedValue.ToString() + "";
                    else
                        Para_yearacp = "";

                    string Para_monthacp = "";
                    if (ddlmonth.SelectedIndex > 0)
                        Para_monthacp = " AND MR_StudioACPlant.Month_ID=" + ddlmonth.SelectedValue.ToString() + "";
                    ...
                    string Para_zoneacp = "";
                    if (ddlzone.SelectedIndex > 0)
                        Para_zoneacp = " AND MR_StudioACPlant.IT_ZONEID=" + ddlzone.SelectedValue.ToString() + "";

                    else
                        Para_zoneacp = "";

                    string Para_stateacp = "";
                    if (ddlstate.SelectedIndex > 0)
                        Para_stateacp = " AND MR_StudioACPlant.StateID=" + ddlstate.SelectedValue.ToString() + "";

                    else
                        Para_stateacp = "";

                    string Para_stnidacp = "";
                    if (ddlstation.SelectedIndex > 0)
                        Para_stnidacp = " AND MR_StudioACPlant.StationID=" + ddlstation.SelectedValue.ToString() + "";
                    else
                        Para_stnidacp = "";

                    string queryacp = @"select ACPlantID,MR_StudioACPlant.Year_ID,MR_StudioACPlant.Month_ID,MR_StudioACPlant.IT_ZONEID,MR_StudioACPlant.StateId,MR_StudioACPlant.StationID,
	                                     ACPlantNM,ACPlantCapacity,ACPlantCurrentHR,ACPlantCurrentMin,ACPlantProgHR,ACPlantProgMin,
	                                     MRWSAC.WorkingStatus_NM,ACPlantNotWorkReason,
                                         CASE WHEN ACPlantInstall_DT IS NOT NULL AND ACPlantInstall_DT ! = '' THEN CONVERT(varchar(11), ACPlantInstall_DT, 103) ELSE NULL END as ACPlantInstall_DT
                                         from MR_StudioACPlant INNER JOIN
                                         MR_WorkingStatus as MRWSAC ON MR_StudioACPlant.ACPlantStatus = MRWSAC.WorkingStatus_ID INNER JOIN
                                         MR_Year ON MR_StudioACPlant.Year_ID = MR_Year.Year_ID INNER JOIN
                                         MR_Month ON MR_StudioACPlant.Month_ID = MR_Month.Month_ID INNER JOIN
                                         HRIS.dbo.IT_ZONE1 ON MR_StudioACPlant.IT_ZONEID = HRIS.dbo.IT_ZONE1.IT_ZONEID INNER JOIN
                                         HRIS.dbo.LKP_State ON MR_StudioACPlant.StateId = HRIS.dbo.LKP_State.StateId INNER JOIN
                                         HRIS.dbo.MST_Station ON MR_StudioACPlant.StationID = HRIS.dbo.MST_Station.StationID 

					                    where HRIS.dbo.IT_ZONE1.WingID=1" +
                                      " " + Para_yearacp + " " + Para_monthacp + " " + Para_zoneacp + " " + Para_stateacp + " " + Para_stnidacp + "";


                    List<string> itemListac = new List<string>();

                    using (SqlDataAdapter adapac = new SqlDataAdapter(queryacp, con))
                    {
                    ...
                    string Para_yearups = "";
                    if (ddlyear.SelectedIndex > 0)
                        Para_yearups = " AND MR_StudioUPS.Year_ID=" + ddlyear.SelectedValue.ToString() + "";
                    else
                        Para_yearups = "";

                    string Para_monthups = "";
                    if (ddlmonth.SelectedIndex > 0)
                        Para_monthups = " AND MR_StudioUPS.Month_ID=" + ddlmonth.SelectedValue.ToString() + "";
                    ...
                    string Para_zoneups = "";
                    if (ddlzone.SelectedIndex > 0)
                        Para_zoneups = " AND MR_StudioUPS.IT_ZONEID=" + ddlzone.SelectedValue.ToString() + "";

                    else
                        Para_zoneups = "";

                    string Para_stateups = "";
                    if (ddlstate.SelectedIndex > 0)
                        Para_stateups = " AND MR_StudioUPS.StateID=" + ddlstate.SelectedValue.ToString() + "";

                    else
                        Para_stateups = "";

                    string Para_stnidups = "";
                    if (ddlstation.SelectedIndex > 0)
                        Para_stnidups = " AND MR_StudioUPS.StationID=" + ddlstation.SelectedValue.ToString() + "";
                    else
                        Para_stnidups = "";

                    string queryups = @"select UPSID,MR_StudioUPS.Year_ID,MR_StudioUPS.Month_ID,MR_StudioUPS.IT_ZONEID,MR_StudioUPS.StateId,MR_StudioUPS.StationID,UPS_NM,UPS_Capacity,UPS_Status
                                         from MR_StudioUPS INNER JOIN                                        
                                         MR_Year ON MR_StudioUPS.Year_ID = MR_Year.Year_ID INNER JOIN
                                         MR_Month ON MR_StudioUPS.Month_ID = MR_Month.Month_ID INNER JOIN
                                         HRIS.dbo.IT_ZONE1 ON MR_StudioUPS.IT_ZONEID = HRIS.dbo.IT_ZONE1.IT_ZONEID INNER JOIN
                                         HRIS.dbo.LKP_State ON MR_StudioUPS.StateId = HRIS.dbo.LKP_State.StateId INNER JOIN
                                         HRIS.dbo.MST_Station ON MR_StudioUPS.StationID = HRIS.dbo.MST_Station.StationID 

					                    where HRIS.dbo.IT_ZONE1.WingID=1" +
                                     " " + Para_yearups + " " + Para_monthups + " " + Para_zoneups + " " + Para_stateups + " " + Para_stnidups + " ";

                    List<string> itemListups = new List<string>();

                    using (SqlDataAdapter adapups = new SqlDataAdapter(queryups, con))
                    {
                    ...
                    string Para_yeardefe = "";
                    if (ddlyear.SelectedIndex > 0)
                        Para_yeardefe = " AND MR_StudioDefectiveEquip.Year_ID=" + ddlyear.SelectedValue.ToString() + "";
                    else
                        Para_yeardefe = "";

                    string Para_monthdefe = "";
                    if (ddlmonth.SelectedIndex > 0)
                        Para_monthdefe = " AND MR_StudioDefectiveEquip.Month_ID=" + ddlmonth.SelectedValue.ToString() + "";

                    else
                        Para_monthdefe = "";

                    string Para_zonedefe = "";
                    if (ddlzone.SelectedIndex > 0)
                        Para_zonedefe = " AND MR_StudioDefectiveEquip.IT_ZONEID=" + ddlzone.SelectedValue.ToString() + "";

                    else
                        Para_zonedefe = "";

                    string Para_statedefe = "";
                    if (ddlstate.SelectedIndex > 0)
                        Para_statedefe = " AND MR_StudioDefectiveEquip.StateID=" + ddlstate.SelectedValue.ToString() + "";

                    else
                        Para_statedefe = "";

                    string Para_stniddefe = "";
                    if (ddlstation.SelectedIndex > 0)
                        Para_stniddefe = " AND MR_StudioDefectiveEquip.StationID=" + ddlstation.SelectedValue.ToString() + "";
                    else
                        Para_stniddefe = "";

                    string querydefe = @"select DefectEquipID,MR_StudioDefectiveEquip.Year_ID,MR_StudioDefectiveEquip.Month_ID,MR_StudioDefectiveEquip.IT_ZONEID,MR_StudioDefectiveEquip.StateId,MR_StudioDefectiveEquip.StationID,DefectEquipNM,DefectEquipProblem,DefectEquipAction
                                         from MR_StudioDefectiveEquip INNER JOIN                                        
                                         MR_Year ON MR_StudioDefectiveEquip.Year_ID = MR_Year.Year_ID INNER JOIN
                                         MR_Month ON MR_StudioDefectiveEquip.Month_ID = MR_Month.Month_ID INNER JOIN
                                         HRIS.dbo.IT_ZONE1 ON MR_StudioDefectiveEquip.IT_ZONEID = HRIS.dbo.IT_ZONE1.IT_ZONEID INNER JOIN
                                         HRIS.dbo.LKP_State ON MR_StudioDefectiveEquip.StateId = HRIS.dbo.LKP_State.StateId INNER JOIN
                                         HRIS.dbo.MST_Station ON MR_StudioDefectiveEquip.StationID = HRIS.dbo.MST_Station.StationID 

					                    where HRIS.dbo.IT_ZONE1.WingID=1" +
                                     " " + Para_yeardefe + " " + Para_monthdefe + " " + Para_zonedefe + " " + Para_statedefe + " " + Para_stniddefe + " ";

                    //ArrayList myArrayList = new ArrayList();

                    List<string> itemListde = new List<string>();

                    using (SqlDataAdapter adapde = new SqlDataAdapter(querydefe, con))
                    {
                ...
                if (ddlreporttype.SelectedValue.ToString() == "1002")
                {
                    ...
                    string Para_yearsatpar = "";
                    if (ddlyear.SelectedIndex > 0)
                        Para_yearsatpar = " AND MR_DSNG_SatteliteParam.Year_ID=" + ddlyear.SelectedValue.ToString() + "";
                    else
                        Para_yearsatpar = "";

                    string Para_monthsatpar = "";
                    if (ddlmonth.SelectedIndex > 0)
                        Para_monthsatpar = " AND MR_DSNG_SatteliteParam.Month_ID=" + ddlmonth.SelectedValue.ToString() + "";

                    else
                        Para_monthsatpar = "";

                    string Para_zonesatpar = "";
                    if (ddlzone.SelectedIndex > 0)
                        Para_zonesatpar = " AND MR_DSNG_SatteliteParam.IT_ZONEID=" + ddlzone.SelectedValue.ToString() + "";

                    else
                        Para_zonesatpar = "";

                    string Para_statesatpar = "";
                    if (ddlstate.SelectedIndex > 0)
                        Para_statesatpar = " AND MR_DSNG_SatteliteParam.StateID=" + ddlstate.SelectedValue.ToString() + "";

                    else
                        Para_statesatpar = "";

                    string Para_stnidsatpar = "";
                    if (ddlstation.SelectedIndex > 0)
                        Para_stnidsatpar = " AND MR_DSNG_SatteliteParam.StationID=" + ddlstation.SelectedValue.ToString() + "";
                    else
                        Para_stnidsatpar = "";



                    string querysatpar = @"select  Slno,MR_DSNG_SatteliteParam.Year_ID,MR_DSNG_SatteliteParam.Month_ID,MR_DSNG_SatteliteParam.IT_ZONEID,MR_DSNG_SatteliteParam.StateId,MR_DSNG_SatteliteParam.StationID,
                                        DSNG_Type,MCPC_SCPC,Sattellite_Transponder,Uplink_Freq,Uplink_Pol,
                                        Downlink_Freq,Downlink_KPol,FEC,SR_Mbps,BW_MHZ
                                        from MR_DSNG_SatteliteParam INNER JOIN
                                        MR_Year ON MR_DSNG_SatteliteParam.Year_ID = MR_Year.Year_ID INNER JOIN
                                        MR_Month ON MR_DSNG_SatteliteParam.Month_ID = MR_Month.Month_ID INNER JOIN
                                        HRIS.dbo.IT_ZONE1 ON MR_DSNG_SatteliteParam.IT_ZONEID = HRIS.dbo.IT_ZONE1.IT_ZONEID INNER JOIN
                                        HRIS.dbo.LKP_State ON MR_DSNG_SatteliteParam.StateId = HRIS.dbo.LKP_State.StateId INNER JOIN
                                        HRIS.dbo.MST_Station ON MR_DSNG_SatteliteParam.StationID = HRIS.dbo.MST_Station.StationID 

					                   where HRIS.dbo.IT_ZONE1.WingID=1" +
                                       " " + Para_yearsatpar + " " + Para_monthsatpar + " " + Para_zonesatpar + " " + Para_statesatpar + " " + Para_stnidsatpar + " ";

                    List<string> itemList_satpara = new List<string>();

                    using (SqlDataAdapter adap1 = new SqlDataAdapter(querysatpar, con))
                    {
                    ...
                    string Para_yearservinfo = "";
                    if (ddlyear.SelectedIndex > 0)
                        Para_yearservinfo = " AND MR_DSNG_ServiceInfo.Year_ID=" + ddlyear.SelectedValue.ToString() + "";
                    else
                        Para_yearservinfo = "";

                    string Para_monthservinfo = "";
                    if (ddlmonth.SelectedIndex > 0)
                        Para_monthservinfo = " AND MR_DSNG_ServiceInfo.Month_ID=" + ddlmonth.SelectedValue.ToString() + "";

                    else
                        Para_monthservinfo = "";

                    string Para_zoneservinfo = "";
                    if (ddlzone.SelectedIndex > 0)
                        Para_zoneservinfo = " AND MR_DSNG_ServiceInfo.IT_ZONEID=" + ddlzone.SelectedValue.ToString() + "";

                    else
                        Para_zoneservinfo = "";

                    string Para_stateservinfo = "";
                    if (ddlstate.SelectedIndex > 0)
                        Para_stateservinfo = " AND MR_DSNG_ServiceInfo.StateID=" + ddlstate.SelectedValue.ToString() + "";

                    else
                        Para_stateservinfo = "";

                    string Para_stnidservinfo = "";
                    if (ddlstation.SelectedIndex > 0)
                        Para_stnidservinfo = " AND MR_DSNG_ServiceInfo.StationID=" + ddlstation.SelectedValue.ToString() + "";
                    else
                        Para_stnidservinfo = "";



                    string queryservinfo = @"select Slno,MR_DSNG_ServiceInfo.Year_ID,MR_DSNG_ServiceInfo.Month_ID,MR_DSNG_ServiceInfo.IT_ZONEID,MR_DSNG_ServiceInfo.StateId,MR_DSNG_ServiceInfo.StationID,
                                        Nm_Service,Service_ID,Video_Brate,Audio_1Brate,
                                        Audio_2Brate,Chroma_Format,Video_PID,Audio_1PID,Audio_2PID,PCR_PID,Scrambling_Type
                                        from MR_DSNG_ServiceInfo INNER JOIN
                                        MR_Year ON MR_DSNG_ServiceInfo.Year_ID = MR_Year.Year_ID INNER JOIN
                                        MR_Month ON MR_DSNG_ServiceInfo.Month_ID = MR_Month.Month_ID INNER JOIN
                                        HRIS.dbo.IT_ZONE1 ON MR_DSNG_ServiceInfo.IT_ZONEID = HRIS.dbo.IT_ZONE1.IT_ZONEID INNER JOIN
                                        HRIS.dbo.LKP_State ON MR_DSNG_ServiceInfo.StateId = HRIS.dbo.LKP_State.StateId INNER JOIN
                                        HRIS.dbo.MST_Station ON MR_DSNG_ServiceInfo.StationID = HRIS.dbo.MST_Station.StationID 

					                   where HRIS.dbo.IT_ZONE1.WingID=1" +
                                       " " + Para_yearservinfo + " " + Para_monthservinfo + " " + Para_zoneservinfo + " " + Para_stateservinfo + " " + Para_stnidservinfo + " ";

                    List<string> itemList_servinfo = new List<string>();

                    using (SqlDataAdapter adapservinfo = new SqlDataAdapter(queryservinfo, con))
                    {
                    ...
                    string Para_yearsf = "";
                    if (ddlyear.SelectedIndex > 0)
                        Para_yearsf = " AND MR_DSNG_SpecialFeed.Year_ID=" + ddlyear.SelectedValue.ToString() + "";
                    else
                        Para_yearsf = "";

                    string Para_monthsf = "";
                    if (ddlmonth.SelectedIndex > 0)
                        Para_monthsf = " AND MR_DSNG_SpecialFeed.Month_ID=" + ddlmonth.SelectedValue.ToString() + "";
                    ...
                    string Para_zonesf = "";
                    if (ddlzone.SelectedIndex > 0)
                        Para_zonesf = " AND MR_DSNG_SpecialFeed.IT_ZONEID=" + ddlzone.SelectedValue.ToString() + "";
                    ...
                    string Para_statesf = "";
                    if (ddlstate.SelectedIndex > 0)
                        Para_statesf = " AND MR_DSNG_SpecialFeed.StateID=" + ddlstate.SelectedValue.ToString() + "";
                    ...
                    string Para_stnidsf = "";
                    if (ddlstation.SelectedIndex > 0)
                        Para_stnidsf = " AND MR_DSNG_SpecialFeed.StationID=" + ddlstation.SelectedValue.ToString() + "";
                    else
                        Para_stnidsf = "";



                    string querysf = @"select Slno,MR_DSNG_SpecialFeed.Year_ID,MR_DSNG_SpecialFeed.Month_ID,MR_DSNG_SpecialFeed.IT_ZONEID,MR_DSNG_SpecialFeed.StateId,MR_DSNG_SpecialFeed.StationID,
                                       SpecialFeed_Dt,Nm_Agency,Duration_Hr,Duration_Min,MR_DSNG_SpecialFeed.Remarks
                                        from MR_DSNG_SpecialFeed INNER JOIN
                                        MR_Year ON MR_DSNG_SpecialFeed.Year_ID = MR_Year.Year_ID INNER JOIN
                                        MR_Month ON MR_DSNG_SpecialFeed.Month_ID = MR_Month.Month_ID INNER JOIN
                                        HRIS.dbo.IT_ZONE1 ON MR_DSNG_SpecialFeed.IT_ZONEID = HRIS.dbo.IT_ZONE1.IT_ZONEID INNER JOIN
                                        HRIS.dbo.LKP_State ON MR_DSNG_SpecialFeed.StateId = HRIS.dbo.LKP_State.StateId INNER JOIN
                                        HRIS.dbo.MST_Station ON MR_DSNG_SpecialFeed.StationID = HRIS.dbo.MST_Station.StationID 

					                   where HRIS.dbo.IT_ZONE1.WingID=1" +
                                       " " + Para_yearsf + " " + Para_monthsf + " " + Para_zonesf + " " + Para_statesf + " " + Para_stnidsf + " ";

                    List<string> itemList_sf = new List<string>();

                    using (SqlDataAdapter adapsf = new SqlDataAdapter(querysf,con))
                    {
                    ...
                    string Para_yearbd = "";
                    if (ddlyear.SelectedIndex > 0)
                        Para_yearbd = " AND MR_DSNG_BreakdownDetails.Year_ID=" + ddlyear.SelectedValue.ToString() + "";
                    else
                        Para_yearbd = "";

                    string Para_monthbd = "";
                    if (ddlmonth.SelectedIndex > 0)
                        Para_monthbd = " AND MR_DSNG_BreakdownDetails.Month_ID=" + ddlmonth.SelectedValue.ToString() + "";
                    ...
                    string Para_zonebd = "";
                    if (ddlzone.SelectedIndex > 0)
                        Para_zonebd = " AND MR_DSNG_BreakdownDetails.IT_ZONEID=" + ddlzone.SelectedValue.ToString() + "";
                    ...
                    string Para_statebd = "";
                    if (ddlstate.SelectedIndex > 0)
                        Para_statebd = " AND MR_DSNG_BreakdownDetails.StateID=" + ddlstate.SelectedValue.ToString() + "";
                    ...
                    string Para_stnidbd = "";
                    if (ddlstation.SelectedIndex > 0)
                        Para_stnidbd = " AND MR_DSNG_BreakdownDetails.StationID=" + ddlstation.SelectedValue.ToString() + "";
                    else
                        Para_stnidbd = "";



                    string querybd = @"select Slno,MR_DSNG_BreakdownDetails.Year_ID,MR_DSNG_BreakdownDetails.Month_ID,MR_DSNG_BreakdownDetails.IT_ZONEID,MR_DSNG_BreakdownDetails.StateId,MR_DSNG_BreakdownDetails.StationID,BD_Date,BD_HR_From,BD_Min_From,
		                               BD_HR_To,BD_Min_To,BD_HR_Duration,BD_Min_Duration,BD_Cause from MR_DSNG_BreakdownDetails INNER JOIN
                                        MR_Year ON MR_DSNG_BreakdownDetails.Year_ID = MR_Year.Year_ID INNER JOIN
                                        MR_Month ON MR_DSNG_BreakdownDetails.Month_ID = MR_Month.Month_ID INNER JOIN
                                        HRIS.dbo.IT_ZONE1 ON MR_DSNG_BreakdownDetails.IT_ZONEID = HRIS.dbo.IT_ZONE1.IT_ZONEID INNER JOIN
                                        HRIS.dbo.LKP_State ON MR_DSNG_BreakdownDetails.StateId = HRIS.dbo.LKP_State.StateId INNER JOIN
                                        HRIS.dbo.MST_Station ON MR_DSNG_BreakdownDetails.StationID = HRIS.dbo.MST_Station.StationID 

					                   where HRIS.dbo.IT_ZONE1.WingID=1" +
                                       " " + Para_yearbd + " " + Para_monthbd + " " + Para_zonebd + " " + Para_statebd + " " + Para_stnidbd + " ";

                    List<string> itemListbdd = new List<string>();

                    using (SqlDataAdapter adapbdd = new SqlDataAdapter(querybd,con))
                    {
                    ...
                    string Para_yeareq = "";
                    if (ddlyear.SelectedIndex > 0)
                        Para_yeareq = " AND MR_StudioNewEquipReceived.Year_ID=" + ddlyear.SelectedValue.ToString() + "";
                    else
                        Para_yeareq = "";

                    string Para_montheq = "";
                    if (ddlmonth.SelectedIndex > 0)
                        Para_montheq = " AND MR_StudioNewEquipReceived.Month_ID=" + ddlmonth.SelectedValue.ToString() + "";
                    ...
                    string Para_zoneq = "";
                    if (ddlzone.SelectedIndex > 0)
                        Para_zoneq = " AND MR_StudioNewEquipReceived.IT_ZONEID=" + ddlzone.SelectedValue.ToString() + "";
                    ...
                    string Para_stateq = "";
                    if (ddlstate.SelectedIndex > 0)
                        Para_stateq = " AND MR_StudioNewEquipReceived.StateID=" + ddlstate.SelectedValue.ToString() + "";
                    ...
                    string Para_stnideq = "";
                    if (ddlstation.SelectedIndex > 0)
                        Para_stnideq = " AND MR_StudioNewEquipReceived.StationID=" + ddlstation.SelectedValue.ToString() + "";
                    else
                        Para_stnideq = "";



                    string queryeqd = @"select EquipmentID,MR_StudioNewEquipReceived.Year_ID,MR_StudioNewEquipReceived.Month_ID,MR_StudioNewEquipReceived.IT_ZONEID,MR_StudioNewEquipReceived.StateId,MR_StudioNewEquipReceived.StationID,Equip_Type,Equipment_NM,                                     
                                     Equip_Status,Equip_Rating,Equip_Make,Equip_Model,Equip_Serialno
                                     from MR_StudioNewEquipReceived INNER JOIN
                                     MR_Year ON MR_StudioNewEquipReceived.Year_ID = MR_Year.Year_ID INNER JOIN
                                     MR_Month ON MR_StudioNewEquipReceived.Month_ID = MR_Month.Month_ID INNER JOIN
                                     HRIS.dbo.IT_ZONE1 ON MR_StudioNewEquipReceived.IT_ZONEID = HRIS.dbo.IT_ZONE1.IT_ZONEID INNER JOIN
                                     HRIS.dbo.LKP_State ON MR_StudioNewEquipReceived.StateId = HRIS.dbo.LKP_State.StateId INNER JOIN
                                     HRIS.dbo.MST_Station ON MR_StudioNewEquipReceived.StationID = HRIS.dbo.MST_Station.StationID 
					                   ...
					                   where HRIS.dbo.IT_ZONE1.WingID=1" +
                                       " " + Para_yeareq + " " + Para_montheq + " " + Para_zoneq + " " + Para_stateq + " " + Para_stnideq + " ";

                    List<string> itemListeq = new List<string>();

                    using (SqlDataAdapter adapeq = new SqlDataAdapter(queryeqd,con))
                    {
                    ...
                    string Para_hc = "";
                    if (ddlyear.SelectedIndex > 0)
                        Para_hc = " AND MR_DSNG_HighlightsCoverage.Year_ID=" + ddlyear.SelectedValue.ToString() + "";
                    else
                        Para_hc = "";

                    string Para_monthhc = "";
                    if (ddlmonth.SelectedIndex > 0)
                        Para_monthhc = " AND MR_DSNG_HighlightsCoverage.Month_ID=" + ddlmonth.SelectedValue.ToString() + "";
                    ...
                    string Para_zonehc = "";
                    if (ddlzone.SelectedIndex > 0)
                        Para_zonehc = " AND MR_DSNG_HighlightsCoverage.IT_ZONEID=" + ddlzone.SelectedValue.ToString() + "";
                    ...
                    string Para_statehc = "";
                    if (ddlstate.SelectedIndex > 0)
                        Para_statehc = " AND MR_DSNG_HighlightsCoverage.StateID=" + ddlstate.SelectedValue.ToString() + "";
                    ...
                    string Para_stnidhc = "";
                    if (ddlstation.SelectedIndex > 0)
                        Para_stnidhc = " AND MR_DSNG_HighlightsCoverage.StationID=" + ddlstation.SelectedValue.ToString() + "";
                    else
                        Para_stnidhc = "";



                    string queryhc = @"select Slno,MR_DSNG_HighlightsCoverage.Year_ID,MR_DSNG_HighlightsCoverage.Month_ID,MR_DSNG_HighlightsCoverage.IT_ZONEID,MR_DSNG_HighlightsCoverage.StateId,MR_DSNG_HighlightsCoverage.StationID,
                                     CASE WHEN Date_Coverage IS NOT NULL AND Date_Coverage ! = '' THEN CONVERT(VARCHAR(11), Date_Coverage, 103) ELSE NULL END as Date_Coverage,
                                     Coverage_Event,Live_FeedHrs,Recorded_FeedHrs,Hot_SwitchingHrs,MR_DSNG_HighlightsCoverage.Remarks
                                     from MR_DSNG_HighlightsCoverage INNER JOIN
                                     MR_Year ON MR_DSNG_HighlightsCoverage.Year_ID = MR_Year.Year_ID INNER JOIN
                                     MR_Month ON MR_DSNG_HighlightsCoverage.Month_ID = MR_Month.Month_ID INNER JOIN
                                     HRIS.dbo.IT_ZONE1 ON MR_DSNG_HighlightsCoverage.IT_ZONEID = HRIS.dbo.IT_ZONE1.IT_ZONEID INNER JOIN
                                     HRIS.dbo.LKP_State ON MR_DSNG_HighlightsCoverage.StateId = HRIS.dbo.LKP_State.StateId INNER JOIN
                                     HRIS.dbo.MST_Station ON MR_DSNG_HighlightsCoverage.StationID = HRIS.dbo.MST_Station.StationID 

					                   where HRIS.dbo.IT_ZONE1.WingID=1" +
                                       " " + Para_hc + " " + Para_monthhc + " " + Para_zonehc + " " + Para_statehc + " " + Para_stnidhc + " ";

                    List<string> itemListhc = new List<string>();

                    using (SqlDataAdapter adaphc = new SqlDataAdapter(queryhc,con))
                    {
        ...
        private void ExportGridToExcel()
        {
            ...
            Response.Charset = "";
            string FileName = "MonthlyReports" + DateTime.Now + ".xls";
        ...
        //    Response.AddHeader("content-disposition", "attachment;filename=MonthlyReports.pdf");
        //    Response.Cache.SetCacheability(HttpCacheability.NoCache);
        ...
        //    Gridrpt.AllowPaging = true;
        //    Gridrpt.DataBind();
        //    Gridrpt.HeaderRow.Style.Add("width", "45%");
        //    Gridrpt.HeaderRow.Style.Add("font-size", "10px");
        //    Gridrpt.HeaderStyle.BackColor = System.Drawing.Color.Green;
        //    Gridrpt.Style.Add("text-decoration", "none");
        //    Gridrpt.Style.Add("font-family", "Arial, Helvetica, sans-serif;");
        //    Gridrpt.Style.Add("font-size", "8px");
