<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Grievance_Reports_Action.aspx.cs" Inherits="PrasarNet.Grievance_Reports_Action"
...
<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="HeadContent">
    ...
    <script type="text/javascript">
        ...
        function ChangeRowColor(row, rowIndex) {
            ...
            var currentRowIndex = parseInt(rowIndex) + 2;
    ...
    <div class="content gradbody" style="margin-bottom: 150px">
        ...
        <div id="Div1" class="row" runat="server" style="padding-right: 20px; margin: auto">
            ...
            <div id="Div3" class="col-md-4 col-sm-4 col-lg-4" runat="server" align="center">
                <br />
                <asp:Label ID="Label43" Style="font-weight: bold; color: Black;"
                    runat="server" Text=":: List of all Grievances with Initial Action::" CssClass="fontforlargebtn"></asp:Label>
                <br />
                <br />
            </div>
            <div id="Div2" class="col-md-4 col-sm-4 col-lg-4" runat="server" align="right">
                <br />
                <asp:LinkButton ID="btnback" runat="server" BorderColor="Black" BorderStyle="Ridge" BorderWidth="2px" CssClass="btn grad4" CausesValidation="False" OnClick="btnback_Click"><span aria-hidden="true" style="color: Black" class="glyphicon glyphicon-home"></span>&nbsp; <span style="font-weight: bold; font-size: medium; color: #000000">Home</span></asp:LinkButton>
                <br />
                <br />
            </div>
        </div>
        <div id="divdashoption" runat="server" style="border: medium ridge #000000; padding-top: 10px; padding-bottom: 10px; margin: auto 30px auto 30px">

            <div class="row" style="padding-top: 10px; padding-bottom: 5px; margin: auto 30px auto 30px">


                <%--<div class="col-md-2 col-lg-2" runat="server" align="center" style="padding: 10px">
                    <div id="div21" runat="server" visible="true">
                        <asp:LinkButton ID="LinkButton2" Text="Station/Offices Info" CssClass="btn grad4 font2" CausesValidation="False"
                            Width="95%" Font-Bold="true" ForeColor="Black" runat="server" OnClick="lnkReports_Click"></asp:LinkButton>

                    </div>
                </div>--%>
                <div class="col-md-1 col-lg-1" runat="server" align="center" style="padding: 10px"></div>
                <div class="col-md-3 col-lg-3" runat="server" align="center" style="padding: 10px">
                    <div id="div17" runat="server" visible="true">
                        <asp:LinkButton ID="lnkReports" Text="Grievance DashBoard" CssClass="btn grad4 fontforlargebtn" CausesValidation="False" BorderColor="Black" BorderStyle="Ridge" BorderWidth="2px"
                            Width="95%" Font-Bold="true" ForeColor="Black" runat="server" OnClick="lnkReports_Click">
                        </asp:LinkButton>
                ...
                <div class="col-md-3 col-lg-3" runat="server" align="center" style="padding: 10px">
                    <div id="divgenusers" runat="server" visible="true">
                        <asp:LinkButton ID="lnkreplyfromoffices" runat="server" CssClass="btn grad4 fontforlargebtn" CausesValidation="False" BorderColor="Black" BorderStyle="Ridge" BorderWidth="2px"
                            Width="95%" OnClick="lnkreplyfromoffices_Click">
                            <span style="font-weight: bold; color: #000000">Reply Recieved from Offices</span></asp:LinkButton>
                    </div>
                ...
                <div class="col-md-3 col-lg-3" runat="server" align="center" style="padding: 10px">
                    <div id="div21" runat="server" visible="true">
                        <asp:LinkButton ID="LinkButton2" Text="Reminders" CssClass="btn grad4 fontforlargebtn" CausesValidation="False" BorderColor="Black" BorderStyle="Ridge" BorderWidth="2px"
                            Width="95%" Font-Bold="true" ForeColor="Black" runat="server" OnClick="LinkButton2_Click">
                        </asp:LinkButton>
                ...
                <%--                 <div class="col-md-3 col-lg-3" runat="server" align="center" style="padding: 10px">
                    <div id="div23" runat="server" visible="true">
                        <asp:LinkButton ID="LinkButton3" Text="Station Email" CssClass="btn grad4 fontforlargebtn" CausesValidation="False" BorderColor="Black" BorderStyle="Ridge" BorderWidth="2px"
                            Width="95%" Font-Bold="true" ForeColor="Black" runat="server" OnClick="lnkReports_Click"></asp:LinkButton>
        ...
        <div id="divsearch" runat="server" visible="false">
            <div class="row" style="margin: auto" runat="server" id="div18">
                <div align="center" class=" col-md-1 col-sm-1 col-lg-1"></div>
                <div align="center" class=" col-md-10 col-sm-10 col-lg-10" runat="server" id="div19">
                    <div runat="server" align="right" style="padding-right: 10px;">
                        <br />
                        ...
                        <table class="table table table-bordered grad2">
                            <tr>
                                ...
                                <td width="60%" align="left" style="padding-left: 15px" class="auto-style3">
                                    <asp:DropDownList ID="ddldept" runat="server" AutoPostBack="True" class="select widthofboxes1" Font-Size="Medium" Font-Bold="true" Width="80%"
                            ...
                            <tr>
                                ...
                                <td width="60%" align="left" style="padding-left: 15px" class="auto-style3">
                                    <asp:DropDownList ID="ddlsection" runat="server" class="select widthofboxes1" Font-Size="Medium" Font-Bold="true" ValidationGroup="sub" Width="80%"
                            ...
                            <tr>
                                ...
                                <td width="60%" align="left" style="padding-left: 15px" class="auto-style3">
                                    <asp:DropDownList ID="ddlregdusertype" runat="server" class="select widthofboxes1" Font-Size="Medium" Font-Bold="true" ValidationGroup="sub" Width="80%"
                                        Height="30px" AppendDataBoundItems="true">
                                    </asp:DropDownList>
                            ...
                            <tr>
                                <td width="40%" align="right" style="padding-right: 30px" class="auto-style3">
                                    <asp:Label ID="Label56" runat="server" Text="Subject of Grievance" ForeColor="Black" class="font"
                                        Style="font-weight: bold;" Font-Bold="True"></asp:Label>
                                    &nbsp;
                                </td>
                                <td width="60%" align="left" style="padding-left: 15px" class="auto-style3">
                                    <asp:DropDownList ID="ddlsubject" runat="server" AutoPostBack="True" class="select widthofboxes1" Font-Size="Medium" Font-Bold="true" Width="80%"
                            ...
                            <tr>
                                <td width="40%" align="right" style="padding-right: 30px" class="auto-style3">
                                    <asp:Label ID="Label7" runat="server" Text="Grievance's Final Status" ForeColor="Black" class="font"
                                        Style="font-weight: bold;"></asp:Label>
                                    &nbsp;
                                </td>
                                <td width="60%" align="left" style="padding-left: 15px" class="auto-style3">
                                    <asp:DropDownList ID="ddlstatus" runat="server" class="select widthofboxes1" Font-Size="Medium" Font-Bold="true" ValidationGroup="sub" Width="80%"
                                        Height="30px" AppendDataBoundItems="true">
                            ...
                            <tr>
                                ...
                                <td width="60%" align="left" style="padding-left: 15px">
                                    <asp:TextBox ID="TextBox1" runat="server" Placeholder="GrievanceID" CssClass="select font2 widthofboxes1" Width="80%" Height="30px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td align="right" style="padding-right: 10px">
                                    <asp:Button ID="btnsearch" runat="server" Text="Search" Font-Size="Large" class="btn select buttondocumentupload" ValidationGroup="sub" Width="130px"
                                        Style="background-color: #99FFCC; color: Black; font-weight: bold" OnClick="btnsearch_Click" BorderColor="Black" BorderStyle="Ridge" BorderWidth="2px" />
                                </td>
                                <td align="left" style="padding-left: 10px">
                                    <asp:Button ID="btncncl" runat="server" Text="Clear" Font-Size="Large" class="btn select gradbody buttondocumentupload" Width="130px"
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body grad2 table-responsive">
                            <div id="divprisearch" style="text-align: center" runat="server" visible="true">
                                <table width="100%">
                                    <tr>
                                        <td align="right" style="padding-top: 10px; padding-left: 10px; padding-right: 10px;">
                                            <asp:LinkButton ID="btnprint1" runat="server" CssClass="btn" CausesValidation="False" BorderColor="Black" BorderStyle="Ridge" BorderWidth="2px"
                                                Width="130px" BackColor="#F5B7B1" OnClick="btnprint1_Click1">
                                        ...
                                        <td align="left" style="padding-top: 10px; padding-left: 10px; padding-right: 10px;">
                            ...
                            <div id="divlast" runat="server" align="center" style="padding-left: 25px; padding-top: 5px; padding-bottom: 10px" class="auto-style1">
                                <br />
                                <asp:Label ID="lbllastvisited" runat="server" Text="Last Visited (Grievance for which action button was clicked): " ForeColor="Black" Font-Bold="true" CssClass="font2"></asp:Label>
                                <asp:LinkButton ID="lnklastvisited" runat="server" Font-Bold="true" CssClass="font2" ForeColor="Blue" OnClick="lnklastvisited_Click"></asp:LinkButton>
                                <asp:HiddenField ID="hid_last_vis_id" runat="server" />
                                <br />
                                <asp:Label ID="lblactiontaken" runat="server" Text="Last Action Taken: " ForeColor="Black" Font-Bold="true" CssClass="font2"></asp:Label>
                                <asp:LinkButton ID="lnkactiontaken" runat="server" Font-Bold="true" CssClass="font2" ForeColor="Blue" OnClick="lnkactiontaken_Click"></asp:LinkButton>
                                <br />
                            </div>

                            <div align="left" style="padding-left: 25px; padding-top: 5px; padding-bottom: 10px" class="auto-style1">
                            ...
                            <asp:GridView ID="grdcomdetails" runat="server" AutoGenerateColumns="False" EmptyDataText="..No Records Found.." AllowPaging="true"
                                HorizontalAlign="Center" BackColor="#F8F9F9" DataKeyNames="Gre_Id" ShowHeaderWhenEmpty="True" ToolTip="Complaints and their Status"
                                ...
                                <columns>
                                    <asp:TemplateField HeaderText="S.No.">
                                        <itemtemplate>
                                            <div runat="server" align="center">
                                                ...
                                                <asp:Label ID="lblrowno" Font-Bold="true" ForeColor="Black" runat="server" Visible="false" Text='<%#Eval("RN") %>' class="fontingrid" />
                                            </div>
                                    ...
                                    <asp:TemplateField HeaderText="Complainant Details">
                                        <itemtemplate>
                                            <div style="padding: 15px" runat="server" align="left">
                                                <asp:Label ID="Label57" Font-Bold="true" ForeColor="Brown" runat="server" Text="Source : " class="fontingrid" />
                                                <asp:Label ID="Label58" Font-Bold="true" ForeColor="Black" runat="server" Text='<%#Eval("typeofcomplainnant") %>' class="font2" />
                                                <br />
                                                <br />
                                    ...
                                    <asp:TemplateField HeaderText="Department/Section to which the Grievance is related (as selected by the Complainant)">
                                        <itemtemplate>
                                            <div style="padding: 15px" runat="server" align="left">
                                                <asp:Label ID="lblDept" Font-Bold="true" ForeColor="Brown" runat="server" Text="Department : " class="fontingrid" />
                                                <asp:Label ID="lbldept2" Font-Bold="true" ForeColor="Black" runat="server" Text='<%#Eval("department") %>' class="fontingrid" />
                                                <br />
                                                <br />
                                                <asp:Label ID="lblsection" Font-Bold="true" ForeColor="Brown" runat="server" Text="Section : " class="fontingrid" />
                                    ...
                                    <asp:TemplateField HeaderText="Final Status">
                                        <itemtemplate>
                                            ...
                                            <div align="center" runat="server" style="padding: 8px">
                                                <asp:Label ID="lnkstatus" CommandName="statusdetails" runat="server" CssClass="btn btn-info font2 def" ForeColor="Blue"
                            ...
                            <asp:Panel ID="pnlPopup" runat="server" CssClass="modalPopup scrol" Style="display: none; height: 65%;" Width="80%">
                                ...
                                <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                                    ...
                                    <contenttemplate>
                                        <div class="header">
                                            <asp:Label ID="Label51" Visible="true" Text="History Of Reminders" Font-Bold="true" Font-Size="Medium" runat="server" />
                ...
                <div class="row" style="margin: auto" runat="server" id="div13">
                    ...
                    <div align="center" class=" col-lg-12 col-md-12" runat="server" id="div14">
                        ...
                        <table class="table table table-bordered grad2new def" cellpadding="5" rules="all" style="border-style: ridge; border-width: medium; z-index: 1; position: relative;">
                            ...
                            <tr class="trnew">
                                ...
                                <td width="60%" align="left" style="padding-left: 15px">
                                    ...
                                    <div style="padding: 5px">
                                        <asp:TextBox ID="txtemailresend" runat="server" Placeholder="Primary Email" Width="90%" AutoPostBack="true" AutoComplete="false" ValidationGroup="resend" CssClass="select font2 widthofboxes1" Height="30px" OnTextChanged="txtemailresend_TextChanged"></asp:TextBox>
                                        &nbsp;<br />
                            ...
                            <tr class="trnew">
                                <td align="right" style="padding-right: 10px">
                                    <asp:Button ID="Button3" runat="server" Text=" Send " Font-Size="Large" class="btn select buttondocumentupload" ValidationGroup="resend"
                        ...
                        <div id="div24" runat="server" style="border: medium ridge #000000; padding-top: 20px; padding-bottom: 20px; padding-left: 20px; padding-right: 20px; margin: auto 20px auto 20px">
                            ...
                            <table class="table table table-bordered grad2new def" cellpadding="5" rules="all" style="border-style: ridge; border-width: medium; z-index: 1; position: relative;">
                                ...
                                <tr class="trnew">
                                    ...
                                    <td width="60%" align="left" style="padding-left: 15px">
                                        <div style="padding: 5px">
                                            <asp:TextBox ID="txtEmailres" runat="server" Placeholder="Primary Email" ReadOnly="true" style="padding-left: 7px" CssClass="select font2 widthofboxes1" Width="90%" Height="30px" ValidationGroup="sub1"></asp:TextBox>
                        ...
                        <div id="div212" runat="server" style="border: medium ridge #000000; padding-top: 20px; padding-bottom: 20px; padding-left: 20px; padding-right: 20px; margin: auto 20px auto 20px">
                            ...
                            <table class="table table table-bordered grad2new def" cellpadding="5" rules="all" style="border-style: ridge; border-width: medium; z-index: 1; position: relative;">
                                ...
                                <tr class="trnew">
                                    ...
                                    <td width="60%" align="left" style="padding-left: 15px" class="auto-style3">
                                        <asp:DropDownList ID="ddldeptfwd" runat="server" AutoPostBack="True" class="select widthofboxes1" Font-Size="Medium" Font-Bold="true" Width="90%"
                                            ValidationGroup="sub1" Height="30px" AppendDataBoundItems="true" style="padding-left: 7px" OnSelectedIndexChanged="ddldeptfwd_SelectedIndexChanged">
                                        </asp:DropDownList>
                                        <br />
                                ...
                                <tr class="trnew">
                                    ...
                                    <td width="60%" align="left" style="padding-left: 15px" class="auto-style3">
                                        <asp:DropDownList ID="ddlsecfwd" runat="server" class="select widthofboxes1" Font-Size="Medium" Font-Bold="true" ValidationGroup="sub1" Width="90%"
                                            Height="30px" AppendDataBoundItems="true" style="padding-left: 7px" OnSelectedIndexChanged="ddlsecfwd_SelectedIndexChanged" AutoPostBack="True">
                                        </asp:DropDownList>
                                        <br />
