<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="utilityDownload.aspx.cs"
    Inherits="PrasarNet.utilityDownload" MasterPageFile="~/Site1.Master" EnableEventValidation="false" %>
    ...
    <div class="content gradbody containerh">
        <div class="row" style="padding: 10px 0px 0px 0px; margin: auto;">
            <div class="col-lg-12 col-md-12 sm-12 xs-12" style="padding-left: 25px; padding-right: 35px;">
                ...
                <asp:Label ID="Label15" class="font pull-right" ForeColor="Black" Font-Bold="true" runat="server"
        ...
        <div class="row" id="divsearch" runat="server" style="margin: auto;">
            <div align="center" class="col-md-4 col-sm-4 col-xs-12 col-lg-3 padd" runat="server"
                style="padding-top: 15px; padding-left: 25px; padding-right: 25px" id="div3">
                <div id="divcat" runat="server" class="grad5 table-hover" style="padding: 20px" align="left">
                    <asp:Repeater ID="RepCat" runat="server" OnItemCommand="RepCat_ItemCommand">
                        <headertemplate>
                            <table cellpadding="0">
                                <tr style="color: Black">
                                    <td>
                                        <span style="font-weight: bold; text-decoration: underline;" class="font2">Filter by Categories of Utility</span>
                                        <br />
                                        <br />
                                    </td>
                                </tr>
                            ...
                            <tr>
                                <td>
                                    <asp:LinkButton ID="lnkelg" runat="server" CssClass="btn gradbody21 font button112"
                                        CausesValidation="False" CommandName="catsearch" Style="color: #000000" Text='<%#Eval("utilityname") %>'>
                                    </asp:LinkButton>
                                    <asp:Label ID="lbldoccatid" runat="server" Text='<%#Eval("uid") %>' Visible="false"></asp:Label>
                                    <br />
                                    <br />
                                </td>
                            </tr>
            ...
            <div id="divgrd" visible="true" class=" col-md-8 col-sm-8 col-xs-12 col-lg-9" runat="server"
                style="padding-top: 15px; padding-left: 20px; padding-right: 20px">
                <div class="panel panel-primary" align="center">
                    <div class="panel-heading grad3">
                        <span style="font-size: medium; font-weight: 700; color: Black;">:: Utilities/Forms
                            ::</span>
                    </div>
                    <div class="panel-body grad2 table-responsive">
                        <%--<div style="text-align: center">
                                <asp:LinkButton ID="btnprint1" Style="background-color: #2E9AFE" runat="server" CssClass="btn"
                    ...
                    <span style="font-weight: bold; color: #000000">Print</span></asp:LinkButton>
                        ...
                        <div class="row" id="divshow" runat="server">
                            <div style="padding-left: 50px" class="col-md-6 col-sm-6 col-xs-12 col-lg-6">
                                <asp:Label ID="Label5" runat="server" class="font2 pull-left" Text="Selected Category: "
                        ...
                        <asp:GridView ID="grdutility" runat="server" DataKeyNames="fileid" AutoGenerateColumns="false"
                            AllowPaging="true" HeaderStyle-BackColor="#61A6F8" HeaderStyle-Font-Bold="true"
                            HeaderStyle-ForeColor="White" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle"
                            EmptyDataText=".. Records Not Found .." ShowHeaderWhenEmpty="True" Width="70%"
                            ...
                            <columns>
                                ...
                                <asp:TemplateField HeaderText="Title/Subject" ItemStyle-Width="85%">
                                    <itemtemplate>
                                        <div style="padding: 10px">
                                            ...
                                            <%--<br />
                                                ...
                                                <asp:Label ID="Label3" Font-Italic="true" runat="server" Text='<%#Eval("createdon") %>'
                                                    Font-Size="X-Small" />
                                                <br />
                                                ...
                                                <asp:Label ID="Label8" Font-Italic="true" runat="server" Text='<%#Eval("lastupdatedon") %>'
                                                    Font-Size="X-Small" />--%>
                                        </div>
                                    </itemtemplate>
                            ...
                            <headerstyle backcolor="#E67E22" font-bold="True" forecolor="Black" horizontalalign="Center"
                                cssclass="centerHeaderText" wrap="True"></headerstyle>
