<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CoronaModulesReports.aspx.cs" Inherits="PrasarNet.CoronaModulesReports" MasterPageFile="~/Site1.Master" %>
      ...
      // Load the Visualization API and the piechart package.  
        ...
        {  
            ...
            {  
                ...
                url: 'CoronaModulesReports.aspx/GetChartDataCorona',  
                data: '{}',  
            ...
            {  
                ...
                data.addColumn('string', 'Week&Year');
  
                for (var i = 0; i < dataValues.length; i++)   
                {  
                    data.addRow([dataValues[i].No_of_Cases, dataValues[i].weeknyear]);
                }  
                // Instantiate and draw our chart, passing in some options  
                data.setColumns([{ calc: function (data, row) { return data.getFormattedValue(row, 0); }, type: 'string' }, 1]);
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentSection" runat="server">
    <div class="content gradbody">
        ...
        <div class="row" runat="server" align="center" style="margin: auto; padding: 20px">
            <div class="col-lg-1 col-md-1"></div>
            <div class="col-lg-10 col-md-10" runat="server" align="center">

                <div id="divi" runat="server" align="center">
                    <div class="table-hover table">
                        <div id="Div8" runat="server" align="center" class="grad3" style="padding-top: 8px; padding-bottom: 8px">
                            <asp:Label ID="Label4" runat="server" Text="Select Filter Options for the Analysis of Covid-19 Cases. Only, the Selection of Chart-Type is Mandatory" CssClass="font2" Style="font-weight: bold; color: Black;"></asp:Label>
                            &nbsp;
                        </div>
                        <table class="table table table-bordered grad2">
                            <tr>
                                <td align="right" style="padding-right: 30px" width="35%">
                                    <asp:Label ID="lbldoccat" runat="server" Text="Chart-Type" ForeColor="Black" class="font2"
                                        Style="font-weight: bold;"></asp:Label>
                                    &nbsp;
                                </td>
                                <td align="left" style="padding-left: 15px" width="65%">
                                    <asp:DropDownList ID="ddlcharttype" runat="server" class="select widthofboxes1 font2"
                                        Height="32px" AppendDataBoundItems="true" ValidationGroup="getgraph">
                                        <asp:ListItem Text="--Select--" Value=""></asp:ListItem>
                                        <asp:ListItem Text="Column Chart" Value="1"></asp:ListItem>
                                        <asp:ListItem Text="Line Chart" Value="2"></asp:ListItem>
                                        <asp:ListItem Text="Pie Chart" Value="3"></asp:ListItem>
                                    </asp:DropDownList>
                                    <asp:Label ID="Label16" runat="server" Text="* Required" Font-Size="Small" Style="font-weight: bold; color: red;"></asp:Label>
                                    &nbsp;
                        
                                    <br />
                                    <asp:RequiredFieldValidator ID="rfvdoccat" runat="server" ControlToValidate="ddlcharttype" ValidationGroup="getgraph"
                                        Display="Dynamic" ErrorMessage="Please Select a Chart-Type" ForeColor="Red" SetFocusOnError="True"
                            ...
                            <tr>
                                <td align="right" style="padding-right: 30px" width="35%">
                                    <asp:Label ID="Label8" runat="server" Text="Status" ForeColor="Black" class="font2"
                                        Style="font-weight: bold;"></asp:Label>
                                    &nbsp;
                                </td>
                                <td align="left" style="padding-left: 15px" width="65%">
                                    <asp:DropDownList ID="ddlstatus" runat="server" class="select widthofboxes1 font2"
                            ...
                            <tr>
                                <td align="right" style="padding-right: 30px" width="35%">
                                    <asp:Label ID="Label9" runat="server" Text="Zone" ForeColor="Black" class="font2"
                                        Style="font-weight: bold;"></asp:Label>
                                    &nbsp;
                                </td>
                                <td align="left" style="padding-left: 15px" width="65%">
                                    <asp:DropDownList ID="ddlzone" runat="server" AutoPostBack="true" class="select widthofboxes1 font2"
                            ...
                            <tr>
                                ...
                                <td align="left" style="padding-left: 15px" width="65%">
                                    <asp:DropDownList ID="ddlstate" runat="server" class="select widthofboxes1 font2"
                                        Height="32px" AppendDataBoundItems="true">
                                    </asp:DropDownList>
                            ...
                            <tr>
                                <td align="right" style="padding-right: 30px" width="35%">
                                    <asp:Label ID="Label12" runat="server" Text="Date(From)" ForeColor="Black" class="font2"
                                        Style="font-weight: bold;"></asp:Label>
                                    &nbsp;
                                </td>
                                <td align="left" style="padding-left: 15px" width="65%">
                                    <asp:TextBox ID="txtdatefrom" runat="server" class="select widthofboxes1 font2" Height="32px" Font-Bold="true" ValidationGroup="add"
                            ...
                            <tr>
                                <td align="right" style="padding-right: 30px" width="35%">
                                    <asp:Label ID="Label13" runat="server" Text="Date(To)" ForeColor="Black" class="font2"
                                        Style="font-weight: bold;"></asp:Label>
                                    &nbsp;
                                </td>
                                <td align="left" style="padding-left: 15px" width="65%">
                                    <asp:TextBox ID="txtdateto" runat="server" class="select widthofboxes1 font2" Height="32px" Font-Bold="true" ValidationGroup="add"
                                        autocomplete="off" placeholder="DD-MM-YYYY" MaxLength="10">
                                    </asp:TextBox>
                            ...
                            <tr>
                                <td align="center" style="padding-right: 30px" colspan="2" class="auto-style1">
                                    <asp:Button ID="btnsearch" runat="server" Text="Get Graph" Font-Size="medium" class="btn select buttondocumentupload" Width="150px" ValidationGroup="getgraph"
                ...
                <div id="divchartmain" runat="server" visible="false" class="scrol2">
                    <div id="divdate" visible="false" runat="server" align="center" style="padding-top: 20px; padding-bottom: 20px">

                        <asp:Label ID="Label3" Font-Bold="true" ForeColor="Brown" class="font2" runat="server" Text="First Covid-19 Case Reported inside the Prasar Bharati, On: "></asp:Label>
                        <asp:Label ID="lblfirst" Font-Bold="true" ForeColor="Black" class="font2" runat="server" Text=" "></asp:Label>
                        <br />
                        <br />

                        <asp:Label ID="Label7" runat="server" Font-Bold="true" ForeColor="Brown" class="font2" Text="Last Covid-19 Case Reported inside the Prasar Bharati, On: "></asp:Label>
                        <asp:Label ID="lbllast" runat="server" Font-Bold="true" ForeColor="Black" class="font2" Text=" "></asp:Label>
                    </div>
                    <div id="chart_div">
                    </div>
                </div>
