<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sharedDocumentsView.aspx.cs" Inherits="PrasarNet.sharedDocumentsView" MasterPageFile="~/Site1.Master" %>
...
//        document.getElementById("mydiv").oncontextmenu = function () { disableclick() };
        ...
        <div id="divgrd" runat="server" visible="true" class="row" style="margin: auto">
            ...
            <div align="center" class=" col-md-10 col-sm-10 col-xs-12 col-lg-10" runat="server"
                ...
                <div id="mydiv"
                    ...
                    <iframe id="shareddoc" runat="server" width="100%" height="100%"
