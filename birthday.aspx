<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="birthday.aspx.cs" Inherits="PrasarNet.birthday"
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentSection" runat="server">
    <div class="content gradbody">
        ...
        <div class="row" style="padding-right: 30px; margin: auto">
            <div id="Div8" class="col-md-12 col-sm-12 col-xs-12 col-lg-12" runat="server" align="right">
                <br />
                <asp:Button ID="btnback" runat="server" Text="< Back" CssClass="btn grad4" Style="color: Black; font-weight: bold"
                    Width="90px" OnClick="btnback_Click1" />
                <br />
            </div>
        </div>
        <div id="divgrd" runat="server" visible="true" class="row" style="margin: auto">
            ...
            <div align="center" class=" col-md-6 col-sm-8 col-lg-8" runat="server"
                id="div6">
                <br />
                <br />
                <div class="panel panel-primary">
                    <div class="panel-heading grad3">
                        <span style="color: Black; font-weight: bold;" class="fontingrid">List of Officials Having
                            Birthday Today(As updated in HRIS)</span>
                        <br />
                        <span style="color: Black; font-weight: bold;" class="font2">(Wishing You a Very
                            Happy &amp; Joyful Day)</span>
                    </div>
                    ...
                    <span style="font-weight: bold; color: #000000">Print</span></asp:LinkButton>
                        ...
                        <asp:GridView ID="grdbday" runat="server" AutoGenerateColumns="false" AllowPaging="true"
                            ...
                            ShowHeaderWhenEmpty="True" Width="85%" OnPageIndexChanging="grdbday_PageIndexChanging"
                            ForeColor="#333333" BorderStyle="Solid" BorderWidth="2px" HorizontalAlign="Center">
                            ...
                            <columns>
                                ...
                                <asp:TemplateField HeaderText="Employee Details" ItemStyle-Width="69%">
                                    <itemtemplate>
                                        <div style="padding: 10px">
                                            <asp:Label ID="Label5" ForeColor="Black" class="font" Font-Bold="true" runat="server" Text='<%# Eval("fullname") %>'></asp:Label>
                                            <br />
                                ...
                                <asp:TemplateField HeaderText="Station" ItemStyle-Width="25%">
                                    <itemtemplate>
                                        <div style="padding-left: 10px">
                                            <asp:Label ID="Label9" class="font" ForeColor="Black" runat="server" Text='<%# Eval("stationdetails") %>'></asp:Label>
                                        </div>
                                    </itemtemplate>
                                    <itemstyle horizontalalign="Left" />
                                    <headerstyle horizontalalign="Center" />
